!(function(t, e) {
    ...
    e in o ||
      ...
      (o[e] = (function(t) {
        ...
        return 1 === t
          ...
          : e.getContext('webgl2', i);
      })(e)));
    var t = o[e];
    return t.isContextLost()
      ? (delete o[e], a(e))
  ...
  function d(t, e) {
    if ((void 0 === e && (e = []), Array.isArray(t) || I(t)))
      for (var n = 0; n < t.length; ++n) d(t[n], e);
    else e.push(t);
    return e;
  }
  function L(t) {
  ...
  function E(t, e) {
    for (var n = [], r = [], o = 0, i = 0; i < t.length; ++i) {
      if (null != e) {
        if (e[o] === i && 1 !== t[i])
          throw new Error(
            "Can't squeeze axis " + i + " since its dim '" + t[i] + "' is not 1"
          );
        (null == e[o] || e[o] > i) && 1 === t[i] && (n.push(t[i]), r.push(i)),
          e[o] <= i && o++;
      }
  ...
  function N(t, e, n) {
    if ('float32' === e)
      for (var r = 0; r < t.length; r++)
        if (isNaN(t[r])) throw Error("The result of the '" + n + "' has NaNs.");
  }
  function k(t, e) {
    if ('float32' !== e)
  ...
  function V(t, e, n) {
    ...
    if ('int32' === e) return n && k(t, e), new Int32Array(t);
  ...
  function G(t, e) {
    for (var n = H(t, e), r = 0; r < n.length; r++) n[r] = 1;
    return n;
  }
  function H(t, e) {
  ...
  function J(t, e, n, r) {
    var o = U(e),
      ...
      s = (function t(e, n, r, o, i, a) {
        ...
        var w = 2 === c ? ',' : '';
        v[0] = '[' + v[0] + w;
        for (g = 1; g < v.length - 1; g++) v[g] = ' ' + v[g] + w;
        var b = ',\n';
        for (g = 2; g < c; g++) b += '\n';
        return (
          (v[v.length - 1] = ' ' + v[v.length - 1] + ']' + (a ? '' : b)), v
        );
      })(t, e, n, o, i),
      u = ['Tensor'];
    return (
  ...
  function Z(t, e) {
    return x(
      Array.isArray(t)
        ? parseFloat(t[0].toFixed(Q)) +
            ' + ' +
            parseFloat(t[1].toFixed(Q)) +
            'j'
        : F(t)
        ? "'" + t + "'"
        : parseFloat(t.toFixed(Q)).toString(),
      e
    );
  }
  function tt(t) {
  ...
  var et = (function() {
      function t(t, e, n) {
        ...
        (this.values = n || R(e, L(this.shape))), (this.strides = U(t));
      }
      return (
        ...
        (t.prototype.toTensor = function() {
          return it.make(this.shape, { values: this.values }, this.dtype);
        }),
        t
      );
    })(),
  ...
  var it = (function() {
    ...
    return (
      ...
      (r.prototype.asType = function(t) {
        return this.throwIfDisposed(), rt.cast(this, t);
      }),
      ...
      (r.prototype.data = function() {
        return m(this, void 0, void 0, function() {
          return C(this, function(t) {
            return this.throwIfDisposed(), [2, nt().read(this.dataId)];
          });
        });
      }),
      (r.prototype.dataSync = function() {
        return this.throwIfDisposed(), nt().readSync(this.dataId);
      }),
      (r.prototype.dispose = function() {
        this.isDisposed ||
          (nt().disposeTensor(this), (this.isDisposedInternal = !0));
      }),
      ...
      (r.prototype.squeeze = function(t) {
        return this.throwIfDisposed(), rt.squeeze(this, t);
      }),
      (r.prototype.clone = function() {
        return this.throwIfDisposed(), rt.clone(this);
      }),
      ...
      (r.prototype.tile = function(t) {
        return this.throwIfDisposed(), rt.tile(this, t);
      }),
      (r.prototype.gather = function(t, e) {
        return (
          void 0 === e && (e = 0), this.throwIfDisposed(), rt.gather(this, t, e)
        );
      }),
      ...
      (r.prototype.dot = function(t) {
        return this.throwIfDisposed(), rt.dot(this, t);
      }),
      ...
      (r.prototype.slice = function(t, e) {
        return this.throwIfDisposed(), rt.slice(this, t, e);
      }),
      (r.prototype.reverse = function(t) {
        return this.throwIfDisposed(), rt.reverse(this, t);
      }),
      ...
      (r.prototype.split = function(t, e) {
        return (
          void 0 === e && (e = 0), this.throwIfDisposed(), rt.split(this, t, e)
        );
      }),
      (r.prototype.stack = function(t, e) {
        return void 0 === e && (e = 0), rt.stack([this, t], e);
      }),
      (r.prototype.unstack = function(t, e) {
        return void 0 === e && (e = 0), rt.unstack(this, e);
      }),
      (r.prototype.pad = function(t, e) {
        return void 0 === e && (e = 0), rt.pad(this, t, e);
      }),
      ...
      (r.prototype.argMin = function(t) {
        return (
          void 0 === t && (t = null), this.throwIfDisposed(), rt.argMin(this, t)
        );
      }),
      (r.prototype.argMax = function(t) {
        return (
          void 0 === t && (t = null), this.throwIfDisposed(), rt.argMax(this, t)
        );
      }),
      ...
      (r.prototype.add = function(t) {
        return this.throwIfDisposed(), rt.add(this, t);
      }),
      (r.prototype.addStrict = function(t) {
        return this.throwIfDisposed(), rt.addStrict(this, t);
      }),
      (r.prototype.atan2 = function(t) {
        return this.throwIfDisposed(), rt.atan2(this, t);
      }),
      (r.prototype.sub = function(t) {
        return this.throwIfDisposed(), rt.sub(this, t);
      }),
      (r.prototype.subStrict = function(t) {
        return this.throwIfDisposed(), rt.subStrict(this, t);
      }),
      (r.prototype.pow = function(t) {
        return this.throwIfDisposed(), rt.pow(this, t);
      }),
      (r.prototype.powStrict = function(t) {
        return this.throwIfDisposed(), rt.powStrict(this, t);
      }),
      (r.prototype.mul = function(t) {
        return this.throwIfDisposed(), rt.mul(this, t);
      }),
      (r.prototype.mulStrict = function(t) {
        return this.throwIfDisposed(), rt.mulStrict(this, t);
      }),
      (r.prototype.div = function(t) {
        return this.throwIfDisposed(), rt.div(this, t);
      }),
      (r.prototype.floorDiv = function(t) {
        return this.throwIfDisposed(), rt.floorDiv(this, t);
      }),
      (r.prototype.divStrict = function(t) {
        return this.throwIfDisposed(), rt.divStrict(this, t);
      }),
      (r.prototype.minimum = function(t) {
        return this.throwIfDisposed(), rt.minimum(this, t);
      }),
      (r.prototype.minimumStrict = function(t) {
        return this.throwIfDisposed(), rt.minimumStrict(this, t);
      }),
      (r.prototype.maximum = function(t) {
        return this.throwIfDisposed(), rt.maximum(this, t);
      }),
      (r.prototype.maximumStrict = function(t) {
        return this.throwIfDisposed(), rt.maximumStrict(this, t);
      }),
      (r.prototype.mod = function(t) {
        return this.throwIfDisposed(), rt.mod(this, t);
      }),
      (r.prototype.modStrict = function(t) {
        return this.throwIfDisposed(), rt.modStrict(this, t);
      }),
      (r.prototype.squaredDifference = function(t) {
        return this.throwIfDisposed(), rt.squaredDifference(this, t);
      }),
      (r.prototype.squaredDifferenceStrict = function(t) {
        return this.throwIfDisposed(), rt.squaredDifferenceStrict(this, t);
      }),
      (r.prototype.transpose = function(t) {
        return this.throwIfDisposed(), rt.transpose(this, t);
      }),
      (r.prototype.notEqual = function(t) {
        return this.throwIfDisposed(), rt.notEqual(this, t);
      }),
      (r.prototype.notEqualStrict = function(t) {
        return this.throwIfDisposed(), rt.notEqualStrict(this, t);
      }),
      (r.prototype.less = function(t) {
        return this.throwIfDisposed(), rt.less(this, t);
      }),
      (r.prototype.lessStrict = function(t) {
        return this.throwIfDisposed(), rt.lessStrict(this, t);
      }),
      (r.prototype.equal = function(t) {
        return this.throwIfDisposed(), rt.equal(this, t);
      }),
      (r.prototype.equalStrict = function(t) {
        return this.throwIfDisposed(), rt.equalStrict(this, t);
      }),
      (r.prototype.lessEqual = function(t) {
        return this.throwIfDisposed(), rt.lessEqual(this, t);
      }),
      (r.prototype.lessEqualStrict = function(t) {
        return this.throwIfDisposed(), rt.lessEqualStrict(this, t);
      }),
      (r.prototype.greater = function(t) {
        return this.throwIfDisposed(), rt.greater(this, t);
      }),
      (r.prototype.greaterStrict = function(t) {
        return this.throwIfDisposed(), rt.greaterStrict(this, t);
      }),
      (r.prototype.greaterEqual = function(t) {
        return this.throwIfDisposed(), rt.greaterEqual(this, t);
      }),
      (r.prototype.greaterEqualStrict = function(t) {
        return this.throwIfDisposed(), rt.greaterEqualStrict(this, t);
      }),
      (r.prototype.logicalAnd = function(t) {
        return this.throwIfDisposed(), rt.logicalAnd(this, t);
      }),
      (r.prototype.logicalOr = function(t) {
        return this.throwIfDisposed(), rt.logicalOr(this, t);
      }),
      (r.prototype.logicalNot = function() {
        return this.throwIfDisposed(), rt.logicalNot(this);
      }),
      (r.prototype.logicalXor = function(t) {
        return this.throwIfDisposed(), rt.logicalXor(this, t);
      }),
      (r.prototype.where = function(t, e) {
        return this.throwIfDisposed(), rt.where(t, this, e);
      }),
      (r.prototype.neg = function() {
        return this.throwIfDisposed(), rt.neg(this);
      }),
      (r.prototype.ceil = function() {
        return this.throwIfDisposed(), rt.ceil(this);
      }),
      (r.prototype.floor = function() {
        return this.throwIfDisposed(), rt.floor(this);
      }),
      (r.prototype.sign = function() {
        return this.throwIfDisposed(), rt.sign(this);
      }),
      (r.prototype.exp = function() {
        return this.throwIfDisposed(), rt.exp(this);
      }),
      (r.prototype.expm1 = function() {
        return this.throwIfDisposed(), rt.expm1(this);
      }),
      (r.prototype.log = function() {
        return this.throwIfDisposed(), rt.log(this);
      }),
      (r.prototype.log1p = function() {
        return this.throwIfDisposed(), rt.log1p(this);
      }),
      (r.prototype.sqrt = function() {
        return this.throwIfDisposed(), rt.sqrt(this);
      }),
      (r.prototype.rsqrt = function() {
        return this.throwIfDisposed(), rt.rsqrt(this);
      }),
      (r.prototype.square = function() {
        return this.throwIfDisposed(), rt.square(this);
      }),
      (r.prototype.reciprocal = function() {
        return this.throwIfDisposed(), rt.reciprocal(this);
      }),
      (r.prototype.abs = function() {
        return this.throwIfDisposed(), rt.abs(this);
      }),
      (r.prototype.clipByValue = function(t, e) {
        return this.throwIfDisposed(), rt.clipByValue(this, t, e);
      }),
      (r.prototype.relu = function() {
        return this.throwIfDisposed(), rt.relu(this);
      }),
      (r.prototype.elu = function() {
        return this.throwIfDisposed(), rt.elu(this);
      }),
      (r.prototype.selu = function() {
        return this.throwIfDisposed(), rt.selu(this);
      }),
      ...
      (r.prototype.prelu = function(t) {
        return this.throwIfDisposed(), rt.prelu(this, t);
      }),
      (r.prototype.sigmoid = function() {
        return this.throwIfDisposed(), rt.sigmoid(this);
      }),
      (r.prototype.logSigmoid = function() {
        return this.throwIfDisposed(), rt.logSigmoid(this);
      }),
      (r.prototype.softplus = function() {
        return this.throwIfDisposed(), rt.softplus(this);
      }),
      (r.prototype.zerosLike = function() {
        return this.throwIfDisposed(), rt.zerosLike(this);
      }),
      (r.prototype.onesLike = function() {
        return this.throwIfDisposed(), rt.onesLike(this);
      }),
      (r.prototype.sin = function() {
        return this.throwIfDisposed(), rt.sin(this);
      }),
      (r.prototype.cos = function() {
        return this.throwIfDisposed(), rt.cos(this);
      }),
      (r.prototype.tan = function() {
        return this.throwIfDisposed(), rt.tan(this);
      }),
      (r.prototype.asin = function() {
        return this.throwIfDisposed(), rt.asin(this);
      }),
      (r.prototype.acos = function() {
        return this.throwIfDisposed(), rt.acos(this);
      }),
      (r.prototype.atan = function() {
        return this.throwIfDisposed(), rt.atan(this);
      }),
      (r.prototype.sinh = function() {
        return this.throwIfDisposed(), rt.sinh(this);
      }),
      (r.prototype.cosh = function() {
        return this.throwIfDisposed(), rt.cosh(this);
      }),
      (r.prototype.tanh = function() {
        return this.throwIfDisposed(), rt.tanh(this);
      }),
      (r.prototype.asinh = function() {
        return this.throwIfDisposed(), rt.asinh(this);
      }),
      (r.prototype.acosh = function() {
        return this.throwIfDisposed(), rt.acosh(this);
      }),
      (r.prototype.atanh = function() {
        return this.throwIfDisposed(), rt.atanh(this);
      }),
      (r.prototype.erf = function() {
        return this.throwIfDisposed(), rt.erf(this);
      }),
      (r.prototype.round = function() {
        return this.throwIfDisposed(), rt.round(this);
      }),
      (r.prototype.step = function(t) {
        return (
          void 0 === t && (t = 0), this.throwIfDisposed(), rt.step(this, t)
        );
      }),
      (r.prototype.softmax = function(t) {
        return (
          void 0 === t && (t = -1), this.throwIfDisposed(), rt.softmax(this, t)
        );
      }),
      ...
      (r.prototype.conv2dTranspose = function(t, e, n, r, o) {
        return this.throwIfDisposed(), rt.conv2dTranspose(this, t, e, n, r, o);
      }),
      ...
      (r.prototype.avgPool = function(t, e, n, r) {
        return this.throwIfDisposed(), rt.avgPool(this, t, e, n, r);
      }),
      (r.prototype.maxPool = function(t, e, n, r) {
        return this.throwIfDisposed(), rt.maxPool(this, t, e, n, r);
      }),
      ...
      (r.prototype.pool = function(t, e, n, r, o) {
        return this.throwIfDisposed(), rt.pool(this, t, e, n, r, o);
      }),
      ...
      (r.prototype.unsortedSegmentSum = function(t, e) {
        return this.throwIfDisposed(), rt.unsortedSegmentSum(this, t, e);
      }),
      (r.prototype.batchToSpaceND = function(t, e) {
        return this.throwIfDisposed(), rt.batchToSpaceND(this, t, e);
      }),
      (r.prototype.spaceToBatchND = function(t, e) {
        return this.throwIfDisposed(), rt.spaceToBatchND(this, t, e);
      }),
      ...
      (r.prototype.depthToSpace = function(t, e) {
        return this.throwIfDisposed(), rt.depthToSpace(this, t, e);
      }),
      (r.prototype.fft = function() {
        return this.throwIfDisposed(), rt.spectral.fft(this);
      }),
      (r.prototype.ifft = function() {
        return this.throwIfDisposed(), rt.spectral.ifft(this);
      }),
      r
    );
  })();
  ...
  Object.defineProperty(at, Symbol.hasInstance, {
    value: function(t) {
      return (
        t instanceof it && null != t.assign && t.assign instanceof Function
      );
    },
  });
  var st,
  ...
  var yt = { float32: lt, int32: ut, bool: ct, complex64: ht };
  function xt(t, e) {
    if ('string' !== t && 'string' !== e) return yt[t][e];
    ...
    _t = (function() {
      ...
      return (
        ...
        (t.prototype.customGrad = function(i) {
          var n = this;
          return (
            A(W(i), 'The f passed in customGrad(f) must be a function.'),
            function() {
        ...
        (t.prototype.time = function(r) {
          return m(this, void 0, void 0, function() {
            ...
            return C(this, function(t) {
              switch (t.label) {
                case 0:
                  return (e = q()), [4, this.backend.time(r)];
                case 1:
                  return ((n = t.sent()).wallMs = q() - e), [2, n];
              }
            });
          });
        }),
        (t.prototype.track = function(t) {
          ...
          return null != this.activeScope && this.activeScope.track.push(t), t;
        }),
        (t.nextTensorId = 0),
        (t.nextVariableId = 0),
        t
  ...
  var Rt,
    Nt = [
      { name: 'DEBUG', type: Ct.BOOLEAN },
      { name: 'IS_BROWSER', type: Ct.BOOLEAN },
      { name: 'WEBGL_LAZILY_UNPACK', type: Ct.BOOLEAN },
      { name: 'WEBGL_CPU_FORWARD', type: Ct.BOOLEAN },
      { name: 'WEBGL_PACK', type: Ct.BOOLEAN },
      { name: 'WEBGL_PACK_BATCHNORMALIZATION', type: Ct.BOOLEAN },
      { name: 'WEBGL_PACK_CLIP', type: Ct.BOOLEAN },
      { name: 'WEBGL_PACK_DEPTHWISECONV', type: Ct.BOOLEAN },
      { name: 'WEBGL_CONV_IM2COL', type: Ct.BOOLEAN },
      { name: 'WEBGL_MAX_TEXTURE_SIZE', type: Ct.NUMBER },
      { name: 'WEBGL_PAGING_ENABLED', type: Ct.BOOLEAN },
      { name: 'WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION', type: Ct.NUMBER },
      {
        name: 'WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE',
        type: Ct.BOOLEAN,
      },
      { name: 'WEBGL_VERSION', type: Ct.NUMBER },
      { name: 'WEBGL_RENDER_FLOAT32_ENABLED', type: Ct.BOOLEAN },
      { name: 'WEBGL_DOWNLOAD_FLOAT_ENABLED', type: Ct.BOOLEAN },
      { name: 'WEBGL_FENCE_API_ENABLED', type: Ct.BOOLEAN },
      { name: 'WEBGL_SIZE_UPLOAD_UNIFORM', type: Ct.NUMBER },
      { name: 'BACKEND', type: Ct.STRING },
      { name: 'EPSILON', type: Ct.NUMBER },
      { name: 'PROD', type: Ct.BOOLEAN },
      { name: 'TENSORLIKE_CHECK_SHAPE_CONSISTENCY', type: Ct.BOOLEAN },
    ];
  function kt(t) {
    try {
      if (null != a(t)) return !0;
    } catch (t) {
      return !1;
    }
    return !1;
  ...
  var Mt = (function() {
    ...
    return (
      (t.setBackend = function(t, e) {
        if ((void 0 === e && (e = !1), !(t in Ft.registry)))
          throw new Error("Backend name '" + t + "' not found in registry");
        (Ft.engine.backend = Ft.findBackend(t)), (Ft.backendName = t);
      }),
      (t.getBackend = function() {
        return Ft.initEngine(), Ft.backendName;
      }),
      (t.disposeVariables = function() {
        Ft.engine.disposeVariables();
      }),
      (t.memory = function() {
        return Ft.engine.memory();
      }),
      (t.profile = function(t) {
        return Ft.engine.profile(t);
      }),
      (t.tidy = function(t, e) {
        return Ft.engine.tidy(t, e);
      }),
      ...
      (t.keep = function(t) {
        return Ft.engine.keep(t);
      }),
      (t.time = function(t) {
        return Ft.engine.time(t);
      }),
      ...
      (t.prototype.evaluateFeature = function(t) {
        ...
        if ('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION' === t) {
          ...
          return 0 === e
            ...
            : (function(t) {
                if (0 === t) return 0;
                var e = a(t);
                return It(e, 'EXT_disjoint_timer_query_webgl2') && 2 === t
                  ? 2
                  : It(e, 'EXT_disjoint_timer_query')
                  ? 1
                  : 0;
              })(e);
        }
        ...
        if ('WEBGL_VERSION' === t) return kt(2) ? 2 : kt(1) ? 1 : 0;
        if ('WEBGL_RENDER_FLOAT32_ENABLED' === t)
          return (function(t) {
            if (0 === t) return !1;
            var e = a(t);
            if (1 === t) {
              if (!It(e, 'OES_texture_float')) return !1;
            } else if (!It(e, 'EXT_color_buffer_float')) return !1;
            return At(e, t);
          })(this.get('WEBGL_VERSION'));
        if ('WEBGL_DOWNLOAD_FLOAT_ENABLED' === t)
          return (function(t) {
            ...
            if (1 === t) {
              if (!It(e, 'OES_texture_float')) return !1;
              if (!It(e, 'WEBGL_color_buffer_float')) return !1;
            } else if (!It(e, 'EXT_color_buffer_float')) return !1;
            return At(e, t);
          })(this.get('WEBGL_VERSION'));
        if ('WEBGL_FENCE_API_ENABLED' === t)
          return (
            2 === (r = this.get('WEBGL_VERSION')) && null != a(r).fenceSync
          );
      ...
      (t.prototype.registerBackend = function(t, e, n, r) {
        ...
        try {
          ...
          return (
            ...
            (this.registry[t] = { backend: i, priority: n }),
            !0
          );
        } catch (e) {
          return (
  ...
  function Bt(t, e) {
    if (
      (A(W(t), 'The f passed in variableGrads(f) must be a function'),
      A(
        null == e ||
          (Array.isArray(e) &&
            e.every(function(t) {
      ...
      for (var n in ((e = []), Ft.engine.registeredVariables))
        e.push(Ft.engine.registeredVariables[n]);
    var r = e.length;
    A(
      0 <
    ...
    var o = Ft.engine.gradients(t, e, null, !0),
      i = o.value,
      a = o.grads;
    A(
      a.some(function(t) {
  ...
  function qt() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    Ft.get('IS_TEST') || console.warn.apply(console, t);
  }
  function jt(t, e, n, r) {
    void 0 === r && (r = !0);
    var o = [];
  ...
  function he(t, e, n, r, o) {
    var i = e[o];
    t & (1 << o) &&
      (i = 0 < n[o] ? Number.MIN_SAFE_INTEGER : Number.MAX_SAFE_INTEGER);
    var a = r[o];
    return i < 0 && (i += a), c(0, i, a - 1);
  }
  function pe(t, e, n, r, o) {
    var i = e[o];
    t & (1 << o) &&
      (i = 0 < n[o] ? Number.MAX_SAFE_INTEGER : Number.MIN_SAFE_INTEGER);
    var a = r[o];
    return i < 0 && (i += a), 0 < n[o] ? c(0, i, a) : c(-1, i, a - 1);
  }
  function fe(t) {
    var e = t;
    if (I(t)) return [t.length];
    if (!Array.isArray(t)) return [];
    for (var n = []; e instanceof Array || I(e); ) n.push(e.length), (e = e[0]);
    return (
      t instanceof Array &&
        Ft.get('TENSORLIKE_CHECK_SHAPE_CONSISTENCY') &&
        (function t(e, n, r) {
          if (((r = r || []), e instanceof Array || I(e))) {
  ...
  function me(t, e, n, r) {
    if ((void 0 === r && (r = 'numeric'), t instanceof it))
    ...
    var a = 'string' !== o ? V(t, o, Ft.get('DEBUG')) : d(t);
    return it.make(i, { values: a }, o);
  }
  function ve(t, n, r) {
    if (!Array.isArray(t))
      throw new Error(
  ...
  function ge(t) {
    ...
    var n = function() {
      for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
      Ft.engine.startScope(r);
      try {
        var n = o.apply(void 0, t);
        return (
          n instanceof Promise &&
            console.error('Cannot return a Promise inside of tidy.'),
          Ft.engine.endScope(n),
          n
        );
      } catch (t) {
        throw (Ft.engine.endScope(null), t);
      }
    };
  ...
  function Ce(t, e, n) {
    ...
    return (
      I(t) || Array.isArray(t) || (t = [t]),
      (e = e || r),
      (t = 'string' !== n ? V(t, n, Ft.get('DEBUG')) : d(t)),
      it.make(e, { values: t }, n)
    );
  }
  function Se(t, e) {
  ...
  function Me(t, e, n) {
    var r = R((n = n || B(e)), L(t));
    return r.fill(e), it.make(t, { values: r }, n);
  }
  function Oe(t, e, n) {
  ...
  function Fe(t, e, n, r) {
    ...
    if (t === e || (t < e && n < 0) || (e < t && 1 < n)) return Ae([0], r);
  ...
  function ze(t, e, n) {
    ...
    if (!T(t.dtype, e)) return it.make(t.shape, { dataId: t.dataId }, e);
  ...
  function Ue(t, e) {
    return it.make(e, { dataId: t.dataId }, t.dtype);
  }
  function Ve(t, e) {
  ...
  function $e(t, e, n, r, o) {
    for (
      ...
      for (
        var p = h * u, f = t.subarray(p, p + u), d = [], m = 0;
        m < f.length;
        m++
      )
    ...
    var x = e.slice();
    return (x[x.length - 1] = r), [Ce(c, x, n), Ce(l, x, 'int32')];
  }
    ...
    sn = (function() {
      ...
      return (
        (t.prototype.getCustomSetupFunc = function() {
          ...
          return function(t, e) {
            (null == n.startLoc &&
              ((n.startLoc = t.getUniformLocationNoThrow(e, 'NAN')),
              null == n.startLoc)) ||
              t.gl.uniform1f(n.startLoc, NaN);
          };
        }),
        t
      );
  ...
  function Cn(t, e, n, r) {
    return 1 === n
      ? r % 2 == e % 2
        ? En(t, e)
        : 'vec4(' + En(t, e - 1) + '.zw, ' + En(t, e + 1) + '.xy)'
      : r % 2 == e % 2
      ? 'vec4(' + En(t, e) + '.xy, ' + En(t, e + 2) + '.xy)'
      : 'vec4(' + En(t, e - 1) + '.zw, ' + En(t, e + 1) + '.zw)';
  }
  ...
  function Nn(t, e, n, r, o) {
    var i = t.map(function(t) {
      ...
      return t.shapeInfo.isUniform
        ? 'uniform float ' + t.name + (1 < e ? '[' + e + ']' : '') + ';'
      ...
      u = t
        .map(function(t) {
          return (function(t, e, n, r) {
            ...
            return (
              (o += r ? Tn(t) : kn(t)),
              (n || y(t.shapeInfo.logicalShape, e.logicalShape)) &&
                (o += r
                  ? (function(t, e, n) {
                      var r = t.name,
        ...
        ? ((a = (function(t, e) {
            switch (t.length) {
              ...
              default:
                throw new Error(
                  t.length +
                    '-D packed output coordinate fetching is not yet supported'
                );
            }
            var n, r, o, i, a, s;
            var u, c, l, h, p;
  ...
  function kn(t) {
    var e,
      ...
      o,
      i,
      a = t.shapeInfo.logicalShape;
    switch (a.length) {
      case 0:
        return (
          (o = (r = t).name),
          (i = 'get' + o.charAt(0).toUpperCase() + o.slice(1)),
          r.shapeInfo.isUniform
            ? 'float ' + i + '() {return ' + o + ';}'
            : '\n    float ' +
              i +
              '() {\n      return sampleTexture(' +
        ...
        return (function(t) {
          ...
          if (t.shapeInfo.isUniform)
            return (
              '\n      float ' +
              r +
              '(int row, int col) {\n        float index = dot(vec2(row, col), vec2(' +
              e[1] +
              ', 1));\n        return ' +
              r +
              'Flat(round(index));\n      }\n    '
      ...
      case 4:
        return (function(t) {
          ...
          return p === a
            ? '\n      float ' +
                r +
                '(int row, int col, int depth, int depth2) {\n        float texR = float(row);\n        float texC =\n            dot(vec3(col, depth, depth2), vec3(' +
                i +
                ', ' +
                o +
                ', 1));\n        vec2 uv = (vec2(texC, texR) + halfCR) /\n                   vec2(' +
        ...
        return (function(t) {
          ...
          if (c.length < e.length)
            return (
              ...
              r +
              '(' +
              Bn(['row', 'col', 'depth', 'depth2', 'depth3'], l) +
              ');\n      }\n    '
            );
          if (t.shapeInfo.isUniform)
            return (
        ...
        return (function(t) {
          ...
          if (l.length < e.length)
            return (
              ...
              r +
              '(' +
              Bn(['row', 'col', 'depth', 'depth2', 'depth3', 'depth4'], h) +
              ');\n      }\n    '
            );
          if (t.shapeInfo.isUniform)
            return (
  ...
  function Tn(t) {
    var e,
      ...
      m,
      v,
      g = t.shapeInfo.logicalShape;
    switch (g.length) {
      case 0:
        return (
          '\n    vec4 get' +
          (v = t.name).charAt(0).toUpperCase() +
          v.slice(1) +
          '() {\n      return texture2D(' +
          v +
          ', halfCR);\n    }\n  '
      ...
      default:
        throw new Error(
          'Packed ' + g.length + '-D input sampling is not yet supported'
        );
    }
  }
  var Dn =
  ...
  function rr(t, e, n, r, o) {
    ...
    for (
      ...
      if (a) {
        y = m + 4 * (l - 1);
        var C = d + r - 1;
        for (v = 4 * l, g = 2 * r, b = 0; b < c; ++b)
          (o[C] = t[y]), (o[C + r] = t[y + 2]), (y += v), (C += g);
      }
      if (s) {
        for (y = m + 4 * (h - l), C = d + (n - 1) * r, E = 0; E < u; ++E)
          (o[C++] = t[y++]), (o[C++] = t[y++]), (y += 2);
        a && (o[d + n * r - 1] = t[y]);
      }
    }
  ...
  function sr(t) {
    if (ir) {
      var e = t.getError();
      if (e !== t.NO_ERROR) throw new Error('WebGL Error: ' + ur(t, e));
    }
  }
  function ur(t, e) {
    switch (e) {
  ...
  function yr() {
    return 2 === Ft.get('WEBGL_VERSION') ? 1 : 4;
  }
  function xr(t) {
    return Ir(
      t,
  ...
  function wr(t, e) {
    var n = Ft.get('WEBGL_MAX_TEXTURE_SIZE');
    if (t <= 0 || e <= 0) {
      var r = '[' + t + 'x' + e + ']';
  ...
  function Tr(t) {
    ...
    if (e !== t.FRAMEBUFFER_COMPLETE)
      throw new Error('Error binding framebuffer: ' + Dr(t, e));
  }
  function Dr(t, e) {
    switch (e) {
  ...
  function Mr(n, t) {
    void 0 === t && (t = !1);
    var e = Ft.get('WEBGL_MAX_TEXTURE_SIZE');
    if (
      (t &&
        ((e *= 2),
    ...
    var o = L(n);
    return n.length <= 1 && o <= e
      ? [1, o]
      : 2 === n.length && n[0] <= e && n[1] <= e
      ? n
      : 3 === n.length && n[0] * n[1] <= e && n[2] <= e
      ? [n[0] * n[1], n[2]]
      : 3 === n.length && n[0] <= e && n[1] * n[2] <= e
      ? [n[0], n[1] * n[2]]
      : 4 === n.length && n[0] * n[1] * n[2] <= e && n[3] <= e
      ? [n[0] * n[1] * n[2], n[3]]
      : 4 === n.length && n[0] <= e && n[1] * n[2] * n[3] <= e
      ? [n[0], n[1] * n[2] * n[3]]
      : g(o);
  }
  function Or(t) {
  ...
  function Fr(t, e) {
    ...
    } else if (Or(t[0]) && Or(e[0])) {
      if (Or(t[1]) && Or(e[1])) return !0;
      if (t[1] === e[1]) return !0;
    }
    return !1;
  }
  var Pr = Object.freeze({
    ...
    validateFramebuffer: Tr,
    getFramebufferErrorMessage: Dr,
  ...
  function Qr(t, e, n, r, o, i, a, s, u) {
    ...
    (function(t, e, n, r, o) {
      ...
      if (o.length < i)
        throw new Error(
          'packedRGBA length (' + o.length + ') must be >=\n        ' + i
        );
      for (
        var a = r % 2 == 1,
          s = n % 2 == 1,
        ...
        for (
          var d = f * n * r, m = f * p, v = a ? 4 : 0, g = r, y = m, x = 0;
          x < c;
          ++x
        ) {
        ...
        if (a) {
          ...
          var C = 2 * r;
          for (v = 4 * l, x = 0; x < c; ++x)
            (o[y] = t[E]), (o[y + 2] = t[E + r]), (E += C), (y += v);
        }
        if (s) {
          for (E = d + (n - 1) * r, y = m + 4 * (h - l), b = 0; b < u; ++b)
            (o[y++] = t[E++]), (o[y++] = t[E++]), (y += 2);
          a && s && (o[m + p - 4] = t[E]);
        }
      }
  ...
  function Zr(t, e, n, r, o) {
    ...
    return tr(a, s, o.downloadUnpackNumChannels), s;
  }
  function to(t, e, n, r) {
    var o = Jn(e, n),
      i = o[0],
    ...
    return tr(s, u, r.downloadUnpackNumChannels), u;
  }
  function eo(t, e, n, r) {
    var o = Jn(e, n),
      i = o[0],
    ...
    io = (function() {
      function t(t) {
        (this.outputTexture = null),
          ...
          (this.itemsToPoll = []),
          (this.gl = null != t ? t : a(Ft.get('WEBGL_VERSION'))),
          1 === Ft.get('WEBGL_VERSION')
            ? ((this.textureFloatExtension = cr(this.gl, 'OES_texture_float')),
              (this.colorBufferFloatExtension = this.gl.getExtension(
                'WEBGL_color_buffer_float'
              )),
              Ft.get('WEBGL_RENDER_FLOAT32_ENABLED') ||
                ((this.textureHalfFloatExtension = cr(
                  this.gl,
            ...
            : (this.colorBufferFloatExtension = cr(
                this.gl,
      ...
      return (
        ...
        (t.prototype.createFloat32MatrixTexture = function(t, e) {
          return this.throwIfDisposed(), Vr(this.gl, t, e, this.textureConfig);
        }),
        (t.prototype.createFloat16MatrixTexture = function(t, e) {
          return this.throwIfDisposed(), Gr(this.gl, t, e, this.textureConfig);
        }),
        (t.prototype.createUnsignedBytesMatrixTexture = function(t, e) {
          return this.throwIfDisposed(), Hr(this.gl, t, e, this.textureConfig);
        }),
        (t.prototype.uploadPixelDataToTexture = function(t, e) {
          this.throwIfDisposed(), Kr(this.gl, t, e);
        }),
        (t.prototype.createFloat16PackedMatrixTexture = function(t, e) {
          return this.throwIfDisposed(), jr(this.gl, t, e, this.textureConfig);
        }),
        (t.prototype.createPackedMatrixTexture = function(t, e) {
          return this.throwIfDisposed(), qr(this.gl, t, e, this.textureConfig);
        }),
        (t.prototype.deleteMatrixTexture = function(t) {
          var e = this;
          this.throwIfDisposed(),
            this.outputTexture === t &&
              (kr(this.gl, this.framebuffer), (this.outputTexture = null)),
            or(this.gl, function() {
        ...
        (t.prototype.createFence = function(t) {
          var e,
            n,
            r = this;
          if (Ft.get('WEBGL_FENCE_API_ENABLED')) {
            var o = t,
            ...
            0 < Ft.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION')
              ? ((e = this.beginQuery()),
                this.endQuery(),
                (n = function() {
                  return r.isQueryAvailable(
                    e,
                    Ft.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION')
                  );
                }))
              : (n = function() {
                  return !0;
        ...
        (t.prototype.debugValidate = function() {
          null != this.program && mr(this.gl, this.program), Tr(this.gl);
        }),
        ...
        (t.prototype.getQueryTimerExtension = function() {
          return (
            null == this.disjointQueryTimerExtension &&
              (this.disjointQueryTimerExtension = cr(
                this.gl,
                2 === Ft.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION')
        ...
        (t.prototype.beginQuery = function() {
          if (2 === Ft.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION')) {
            var t = this.gl,
        ...
        (t.prototype.bindTextureToFrameBuffer = function(t) {
          this.throwIfDisposed(),
            ...
            this.autoDebugValidate && Tr(this.gl);
        }),
        (t.prototype.unbindTextureToFrameBuffer = function() {
          null != this.outputTexture
            ? (Nr(this.gl, this.outputTexture, this.framebuffer),
              this.autoDebugValidate && Tr(this.gl))
            : kr(this.gl, this.framebuffer);
        }),
      ...
      function t(t) {
        ...
        var e = Fn(this.rank),
          n = (function(t) {
            ...
            if (2 === t) return 'sourceLoc.x, sourceLoc.y';
            if (3 === t) return 'sourceLoc.x, sourceLoc.y, sourceLoc.z';
            if (4 === t)
        ...
        (t.prototype.getCustomSetupFunc = function(n) {
          ...
          return function(t, e) {
            if (
              ...
              if (1 === r.rank) t.gl.uniform1i(r.startLoc, n[0]);
              else if (2 === r.rank) t.gl.uniform2i(r.startLoc, n[0], n[1]);
              else if (3 === r.rank)
                t.gl.uniform3i(r.startLoc, n[0], n[1], n[2]);
              else {
                if (4 !== r.rank)
                  throw Error(
                    'Slicing for rank ' + r.rank + ' is not yet supported'
                  );
  ...
  function Mo(t, e) {
    if (t === $n.UPLOAD) return e ? Kn.PACKED_2X2_FLOAT32 : Kn.UNPACKED_FLOAT32;
    if (t === $n.RENDER || null == t)
      return e
        ? Ft.get('WEBGL_RENDER_FLOAT32_ENABLED')
          ? Kn.PACKED_2X2_FLOAT32
          : Kn.PACKED_2X2_FLOAT16
        : Ft.get('WEBGL_RENDER_FLOAT32_ENABLED')
        ? Kn.UNPACKED_FLOAT32
        : Kn.UNPACKED_FLOAT16;
  ...
  function ii(t, e, n) {
    return void 0 === e && (e = 'float32'), new et(t, (e = e || 'float32'), n);
  }
  function ai(t, e) {
  ...
  var si = ge({
    ...
    ci = ge({
      clone_: function(t) {
        ...
        return Ft.engine.runKernel(
          function(t) {
            return it.make(e.shape, { dataId: e.dataId }, e.dtype);
          },
          { $x: e },
          function(t) {
            return {
    ...
    pi = ge({
      ...
      eye_: function(t, e, n, r) {
        ...
        if (null == n) return s;
        if (1 === n.length) return Ti(pi(s, 0), [n[0], 1, 1]);
        if (2 === n.length) return Ti(pi(pi(s, 0), 0), [n[0], n[1], 1, 1]);
        if (3 === n.length)
          return Ti(pi(pi(pi(s, 0), 0), 0), [n[0], n[1], n[2], 1, 1]);
        throw new Error(
    ...
    di = ge({
      fromPixels_: function(t, e) {
        ...
        return Ft.engine.fromPixels(t, e);
      },
    }),
    mi = ge({
    ...
    Ci = ge({
      randomNormal_: function(t, e, n, r, o) {
        ...
        for (
          var i = new ri(e, n, r, !1, o), a = ii(t, r), s = 0;
          s < a.values.length;
          s++
        )
    ...
    ki = ge({
      stack_: function(t, e) {
        ...
        if (
          (A(1 <= n.length, 'Pass at least one tensor to tf.stack'),
          1 === n.length)
        )
                    ...
                    for (e = 0; e < a[0]; ++e)
                      for (n = 0; n < a[1]; ++n)
                        for (var r = 0; r < a[2]; ++r)
                          t = t.add(
                            i.slice(
                              [e * s.shape[0], n * s.shape[1], r * s.shape[2]],
    ...
    Di = ge({
      truncatedNormal_: function(t, e, n, r, o) {
        if (
          ...
          throw new Error('Unsupported data type ' + r);
        for (
          var i = new ri(e, n, r, !0, o), a = ii(t, r), s = 0;
          s < a.values.length;
          s++
        )
          a.values[s] = i.nextValue();
          ...
          switch (t.label) {
            case 0:
              return (
                ...
                A(
                  1 === e.rank,
                  'x should be 1D tensor, but got x (' + e.shape + ').'
                ),
                A(
                  1 === n.rank,
                  'y should be 1D tensor, but got y (' + n.shape + ').'
                ),
                [4, e.data()]
              );
            case 1:
            ...
            case 2:
              for (o = t.sent(), i = new Set(o), c = a = 0; c < r.length; c++)
                i.has(r[c]) || a++;
              for (
                s = new et([a], e.dtype), u = new et([a], 'int32'), l = c = 0;
                c < r.length;
                c++
              )
  ...
  var Oi = (function() {
    function t(t, e) {
      if (
        ...
        (this.binaryCache = {}),
        (this.disposed = !1),
        Ft.get('WEBGL_VERSION') < 1)
      )
        throw new Error('WebGL is not supported on this device');
      if (null == t) {
        var n = a(Ft.get('WEBGL_VERSION'));
        (this.gpgpu = new io(n)),
          (this.canvas = n.canvas),
          (this.gpgpuCreatedLocally = !0);
      } else (this.gpgpuCreatedLocally = !1), (this.canvas = t.gl.canvas);
      Ft.get('WEBGL_PAGING_ENABLED') &&
    ...
    return (
      ...
      (t.prototype.readSync = function(t) {
        ...
        return (
          ...
          (a =
            'complex64' === r
              ? Ve(o.real.dataSync(), o.imag.dataSync())
          ...
          return C(this, function(t) {
            switch (t.label) {
              case 0:
                ...
                if (
                  (this.pendingRead.set(x, []),
                  !Ft.get('WEBGL_DOWNLOAD_FLOAT_ENABLED') &&
                    2 === Ft.get('WEBGL_VERSION'))
                )
                  throw new Error(
              ...
              case 1:
                return (
                  t.sent(),
                  p instanceof WebGLTexture
                    ? (f = this.getValuesFromTexture(x))
                    : u
                    ? ((d = this.getBatchDim(c)),
                      (v = m = 1),
                      c.length &&
                        ((n = this.getRowsCols(c)), (m = n[0]), (v = n[1])),
                      (f = this.gpgpu.downloadPackedMatrixFromBuffer(
                        p,
                        d,
                        m,
                        v,
                    ...
                    : (f = this.gpgpu.downloadFloat32MatrixFromBuffer(
                        p,
                        s[0],
                        s[1]
                      )),
                  ...
                  this.pendingDisposal.has(x) &&
                    (this.pendingDisposal.delete(x), this.disposeData(x)),
                  [2, g]
                );
            }
          });
      ...
      (t.prototype.getValuesFromTexture = function(t) {
        var e,
          ...
          i = n.texture,
          a = n.texShape;
        if (Ft.get('WEBGL_DOWNLOAD_FLOAT_ENABLED')) {
          if (this.texData.get(t).isPacked) {
            var s = this.getBatchDim(r),
              u = 1,
              c = 1;
            return (
              r.length && ((u = (e = this.getRowsCols(r))[0]), (c = e[1])),
        ...
        (l.size = L(r)), (this.texData.get(l.dataId).usage = $n.DOWNLOAD);
        var h = new Un(r);
        this.compileAndRun(h, [{ shape: r, dtype: o, dataId: t }], l, null, !1);
        var p = this.texData.get(l.dataId),
          f = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(
            p.texture,
            p.texShape[0],
            p.texShape[1]
          );
      ...
      (t.prototype.startTimer = function() {
        return 0 < Ft.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION')
        ...
        if (!this.pendingDisposal.has(t))
          if (this.pendingRead.has(t)) this.pendingDisposal.add(t);
            ...
            null != n && this.releaseTexture(t, n, r, o, a),
              null != i && (i.real.dispose(), i.imag.dispose()),
      ...
      (t.prototype.getCPUBackend = function() {
        return Ft.get('WEBGL_CPU_FORWARD')
      ...
      (t.prototype.complex = function(t, e) {
        ...
        return (
          (this.texData.get(n.dataId).complexTensors = {
            real: Ft.engine.keep(t.clone()),
            imag: Ft.engine.keep(e.clone()),
          }),
          n
        );
      }),
      ...
      (t.prototype.batchNormalization = function(t, e, n, r, o, i) {
        ...
        if (
          ...
          Ft.get('WEBGL_PACK_BATCHNORMALIZATION'))
        ) {
      ...
      (t.prototype.reduce = function(t, e, n) {
        var r = t.shape[0],
          o = t.shape[1],
          i = se(o),
          a = new wo({ windowSize: i, inSize: o, batchSize: r }, e),
          s = a.outputShape,
          u = s[0],
          c = s[1],
      ...
      (t.prototype.argReduce = function(t, e, n) {
        ...
        var i = se(o),
          a = new Ke({ windowSize: i, inSize: o, batchSize: r }, e, null == n),
          s = a.outputShape,
          u = s[0],
          c = s[1],
      ...
      (t.prototype.unsortedSegmentSum = function(t, e, n) {
        var r = 0,
          o = ne([r], t.rank),
          i = t;
        null != o && ((i = t.transpose(o)), (r = oe(1, t.rank)[0]));
        ...
        return null != o && (l = l.transpose(re(o))), l;
      }),
      (t.prototype.segOpCompute = function(t, e, n, r, o) {
        ...
        return (
          ...
          p.shape[1] === o
            ? p
            : ((n = Fe(0, o).tile([a / s])), this.segOpCompute(p, e, n, r, o))
        );
      }),
      (t.prototype.argMin = function(t, e) {
        var n = [e];
      ...
      (t.prototype.select = function(t, e, n) {
        var r = new To(t.rank, e.shape, e.rank),
      ...
      (t.prototype.conv2d = function(t, e, n) {
        if (Ft.get('WEBGL_CONV_IM2COL') && 1 === t.shape[0])
      ...
      (t.prototype.depthwiseConv2D = function(t, e, n) {
        var r;
        return Ft.get('WEBGL_PACK_DEPTHWISECONV') &&
          1 === n.dilationWidth &&
          1 === n.dilationHeight &&
          n.padInfo.left <= 1 &&
          n.strideWidth <= 2 &&
          ...
          : ((r = new wn(n)), this.compileAndRun(r, [t, e]));
      }),
      (t.prototype.depthwiseConv2DDerInput = function(t, e, n) {
        var r = new gn(n);
        return this.compileAndRun(r, [t, e]);
      ...
      (t.prototype.reshape = function(t, e) {
        return this.texData.get(t.dataId).isPacked && !Fr(t.shape, e)
      ...
      (t.prototype.packedReshape = function(t, e) {
        var n = t.reshape(
            [this.getBatchDim(t.shape)].concat(this.getRowsCols(t.shape))
          ),
      ...
      (t.prototype.compileAndRun = function(i, t, e, n, r) {
        ...
        if (
          (void 0 === r && (r = !0),
          null == e &&
            (e = i.usesPackedTextures
              ? this.makePackedTensor(i.outputShape, t[0].dtype)
              : this.makeOutputArray(i.outputShape, t[0].dtype)),
          0 === e.size)
        )
          return (this.texData.get(e.dataId).values = _(e.dtype, 0)), e;
        var o = t.map(function(t) {
          ...
          if (null == e.texture) {
            if (
              !i.usesPackedTextures &&
              L(t.shape) <= Ft.get('WEBGL_SIZE_UPLOAD_UNIFORM')
            )
              return {
                shape: t.shape,
                texData: null,
            ...
            i.usesPackedTextures && ((e.isPacked = !0), (e.shape = t.shape));
            ...
            e.isPacked
              ? ((n = new Uo(t.shape)),
                (r = a.compileAndRun(
                  n,
                  [t],
                  it.make(n.outputShape, {}, t.dtype)
                )))
              : ((n = new go(t.shape)),
                (r = a.compileAndRun(
                  n,
                  [t],
                  a.makePackedTensor(t.shape, t.dtype)
                ))),
              (e = a.texData.get(r.dataId)),
              (t = r);
          } else if (e.isPacked && !Fr(e.shape, t.shape)) {
            a.delayedStorage = !1;
            var o = t.dataSync();
            (a.delayedStorage = !0),
              (t = it.make(t.shape, { values: o }, t.dtype)),
        ...
        var s,
          ...
          c = (function(t, e, n) {
            ...
            e.concat(n).forEach(function(t) {
              r +=
                t.shape + '_' + (t.isUniform ? 'uniform' : t.texData.texShape);
            });
            var o = t.userCode,
              ...
              for (
                var o = r.userCode,
                  ...
                  u = Nn(
                    ...
                    s,
                    o,
                    !0 === r.supportsBroadcasting,
                    r.usesPackedTextures
                  ),
                  c = t.createProgram(u),
                  l = {},
                  h = 0;
                h < r.variableNames.length;
                h++
              ) {
        ...
        if (
          (h && (s = this.startTimer()),
          (function(a, t, e, n) {
            ao(a.inShapeInfos, t), ao([a.outShapeInfo], [e]);
            var r = e.texData.texture,
              o = e.texData.texShape,
              s = a.gpgpu;
            e.texData.isPacked
              ? s.setOutputPackedMatrixTexture(r, o[0], o[1])
              : s.setOutputMatrixTexture(r, o[0], o[1]),
              ...
              t.forEach(function(t, e) {
                ...
                if (null != r) {
                  if (t.isUniform) {
                    if (1 === L(t.shape)) s.gl.uniform1f(r, t.uniformValues[0]);
                    else {
          ...
          for (
            var p = this.numBytesInGPU - this.NUM_BYTES_BEFORE_PAGING;
      ...
      (t.prototype.uploadToGPU = function(t) {
        ...
        if (null == i) {
          ...
          if (((n.texture = h), null != o)) {
            if (s) {
              var p = this.getBatchDim(r),
                f = 1,
                d = 1;
              r.length && ((f = (e = this.getRowsCols(r))[0]), (d = e[1])),
            ...
            } else this.gpgpu.uploadMatrixToTexture(h, l[0], l[1], Fi(o));
            (n.values = null),
      ...
      (t.prototype.convertAndCacheOnCPU = function(t, e) {
        ...
        return (
          n &&
            null != o &&
            (this.releaseTexture(t, o, i, s, u),
            (r.texture = null),
            (r.texShape = null)),
          (r.usage = $n.UPLOAD),
          null != e &&
            (r.values = (function(t, e) {
      ...
      (t.prototype.releaseTexture = function(t, e, n, r, o) {
        var i = this.texData.get(t),
          a = i.shape,
          s = i.dtype;
        if (Ft.get('WEBGL_PAGING_ENABLED')) {
      ...
      (t.prototype.acquireTexture = function(t, e, n, r) {
        var o = this.texData.get(t),
          ...
          a = o.dtype;
        return (
          Ft.get('WEBGL_PAGING_ENABLED') && this.lruDataGPU.push(t),
  ...
  var ma = ge({
      batchNormalization2d_: function(t, e, n, r, o, i) {
        ...
        var a,
          s,
          u = me(t, 'x', 'batchNormalization'),
          c = me(e, 'mean', 'batchNormalization'),
          l = me(n, 'variance', 'batchNormalization');
        return (
          null != o && (a = me(o, 'scale', 'batchNormalization')),
    ...
    ya = ge({
      batchNormalization_: function(t, e, n, c, r, o) {
        ...
        var l,
          i,
          h,
          p = me(t, 'x', 'batchNormalization'),
          f = me(e, 'mean', 'batchNormalization'),
          d = me(n, 'variance', 'batchNormalization');
        return (
          null != r && (l = me(r, 'scale', 'batchNormalization')),
          ...
          (h =
            0 === p.rank || 1 === p.rank
              ? p.as4D(1, 1, 1, p.size)
              : 2 === p.rank
              ? p.as4D(1, 1, p.shape[0], p.shape[1])
              : 3 === p.rank
              ? p.as4D(1, p.shape[0], p.shape[1], p.shape[2])
              : p),
          Ft.engine
            .runKernel(
              function(t) {
              ...
              function(n) {
                ...
                return {
                  $x: function() {
                    return 1 === f.rank
                      ? n
                          .mul(Ti(s.as4D(1, 1, 1, f.shape[0]), e))
                          .mul(t)
                          .reshape(p.shape)
                      : n
                          .mul(s)
                  ...
                  $mean: function() {
                    ...
                    return 1 === f.rank && (t = t.sum(r)), t.reshape(f.shape);
                  },
                  $variance: function() {
                    var t = u.mul(i).mul(a);
                    return 1 === f.rank && (t = t.sum(r)), t.reshape(f.shape);
                  ...
                  $scale: function() {
                    var t = i.mul(s),
                      e = n.mul(t);
                    return 1 === f.rank && (e = e.sum(r)), e.reshape(f.shape);
                  },
                  $offset: function() {
                    var t = n;
                    return 1 === f.rank && (t = t.sum(r)), t.reshape(f.shape);
  ...
  function ba(t, e, n, r, o, i, a) {
    ...
    var f,
      ...
      })(o, c, l, h, x, w, b, Sa(d, C), Sa(m, S), Sa(v, _)),
      N = R.padInfo,
      k = R.outDepth,
      T = R.outHeight,
      D = R.outWidth,
  ...
  var ka = ge({
      matMul_: function(t, e, n, r) {
        ...
        var s = n ? i.shape[i.rank - 2] : i.shape[i.rank - 1],
          ...
          d = L(p);
        A(
          2 <= i.rank && 2 <= a.rank && i.rank === a.rank,
  ...
  var Oa = ge({
    ...
    Pa = ge({
      conv3d_: function(t, e, n, r, o, i) {
        void 0 === o && (o = 'NHWC'), void 0 === i && (i = [1, 1, 1]);
        var a,
          s = me(t, 'x', 'conv3d'),
          u = me(e, 'filter', 'conv3d'),
          c = s,
          l = !1;
        4 === s.rank &&
          ((l = !0),
    ...
    za = ge({
      conv2dTranspose_: function(t, e, n, r, o, i) {
        return Ia(
          n,
          me(t, 'x', 'conv2dTranspose'),
          me(e, 'filter', 'conv2dTranspose'),
          r,
          o,
          i
        );
    ...
    Ya = ge({
      pool_: function(t, e, n, r, o, i) {
        ...
        var c,
          ...
          f,
          d,
          m = xa(s.shape, e, i, o, r),
          v = [m.dilationHeight, m.dilationWidth];
        c =
          'same' === r
            ? ((l = [m.filterHeight, m.filterWidth]),
              (h = v),
              (p = l
                .map(function(t, e) {
                  return t + (t - 1) * (h[e] - 1);
      ...
      slice_: function(t, e, n) {
        ...
        (r =
          ...
          (o = (o =
            ...
            return 0 <= t
              ? t
              : (A(-1 === t, 'Bad value in size'), i.shape[e] - r[e]);
          })),
          (function(t, e, n) {
            A(
              t.rank === e.length,
  ...
  function ns(e, t, n, r, o) {
    var i = t[0];
    return (
      i.rank < n.rank && (i = i.reshape(Zt(i.shape, r))),
  ...
  var rs = ge({
      all_: function(t, e, n) {
        ...
        var r = me(t, 'x', 'all', 'bool'),
          ...
          i = o,
          a = ne(i, r.rank);
        null != a && ((r = r.transpose(a)), (i = oe(i.length, r.rank)));
        var s = Ft.engine.runKernel(
          function(t) {
            return t.all(r, i);
          },
          { $x: r }
    ...
    is = ge({
      argMax_: function(t, e) {
        ...
        var r = te(e, n.shape),
          o = ne(r, n.rank);
        return (
          null != o && ((n = n.transpose(o)), (r = oe(r.length, n.rank))),
          Ft.engine.runKernel(
            function(t) {
    ...
    us = ge({
      max_: function(t, e, n) {
        ...
        var r = me(t, 'x', 'max'),
          ...
          a = i,
          s = ne(a, r.rank);
        null != s && ((r = r.transpose(s)), (a = oe(a.length, r.rank)));
        var u = Ft.engine.runKernel(
          function(t, e) {
            return e(t.max(r, a));
          },
          { $x: r },
      ...
      sum_: function(t, e, a) {
        ...
        return Lt(function(n) {
          var t = ne(s, n.rank),
            e = s,
            r = n;
          null != t && ((r = n.transpose(t)), (e = oe(e.length, n.rank)));
          var o = Ft.engine.runKernel(
            function(t) {
              return t.sum(r, e);
            },
            { permutedX: r }
    ...
    fs = ge({
      prod_: function(t, e, n) {
        ...
        var o = te(e, r.shape),
          ...
          a = o,
          s = r;
        null != i && ((s = r.transpose(i)), (a = oe(a.length, r.rank)));
        var u = Ft.engine.runKernel(
          function(t) {
            return t.prod(s, a);
          },
  ...
  var ds = ge({
    ...
    gs = ge({
      greaterEqual_: function(t, e) {
        var n,
          r = me(t, 'a', 'greaterEqual'),
          o = me(e, 'b', 'greaterEqual');
        return (
          (n = bt(r, o)),
          (r = n[0]),
          (o = n[1]),
    ...
    ys = ge({
      greaterEqualStrict_: function(t, e) {
        ...
        return (
          f(n.shape, r.shape, 'Error in greaterEqualStrict: '),
          n.greaterEqual(r)
        );
      },
    }),
    ...
    Es = ge({
      lessEqualStrict_: function(t, e) {
        ...
        return (
          f(n.shape, r.shape, 'Error in lessEqualStrict: '), n.lessEqual(r)
        );
      },
    }),
    Cs = ge({
  ...
  var Rs = ge({
    ...
    ks = ge({
      addStrict_: function(t, e) {
        var n = me(t, 'a', 'addStrict'),
          r = me(e, 'b', 'addStrict');
        return f(n.shape, r.shape, 'Error in addStrict: '), n.add(r);
      },
    }),
    Ts = ge({
      atan2_: function(t, e) {
    ...
    Ds = ge({
      div_: function(t, e) {
        ...
        var a = Je(o.shape, i.shape);
        return Ft.engine.runKernel(r, { $a: o, $b: i }, function(r) {
          return {
            $a: function() {
    ...
    Is = ge({
      divStrict_: function(t, e) {
        var n = me(t, 'a', 'div'),
          r = me(e, 'b', 'div');
        return f(n.shape, r.shape, 'Error in divideStrict: '), n.div(r);
      },
    }),
    As = ge({
    ...
    Os = ge({
      maximumStrict_: function(t, e) {
        ...
        return f(n.shape, r.shape, 'Error in maximumStrict: '), n.maximum(r);
      },
    }),
    Fs = ge({
    ...
    Ps = ge({
      minimumStrict_: function(t, e) {
        ...
        return f(n.shape, r.shape, 'Error in minimumStrict: '), n.minimum(r);
      },
    }),
    Bs = ge({
      mod_: function(t, e) {
    ...
    Ls = ge({
      modStrict_: function(t, e) {
        var n = me(t, 'a', 'modStrict'),
          r = me(e, 'b', 'modStrict');
        return f(n.shape, r.shape, 'Error in modStrict: '), n.mod(r);
      },
    }),
    Ws = ge({
      mul_: function(t, e) {
    ...
    zs = ge({
      mulStrict_: function(t, e) {
        var n = me(t, 'a', 'mul'),
          r = me(e, 'b', 'mul');
        return f(n.shape, r.shape, 'Error in multiplyStrict: '), n.mul(r);
      },
    }),
    Us = ge({
      pow_: function(t, e) {
              ...
              return {
                ...
                $exp: function() {
                  var t = r.mul(n.mul(o.log()).toFloat()),
                    e = Qe(i.shape, a);
                  return 0 < e.length && (t = t.sum(e)), t.reshape(i.shape);
                },
              };
            }
          )
    ...
    Vs = ge({
      powStrict_: function(t, e) {
        return f(t.shape, e.shape, 'Error in powStrict: '), t.pow(e);
      },
    }),
    Gs = ge({
      squaredDifference_: function(t, e) {
        var n,
          r = me(t, 'a', 'squaredDifference'),
          o = me(e, 'b', 'squaredDifference');
        return (
          (n = bt(r, o)),
          (r = n[0]),
          (o = n[1]),
    ...
    Hs = ge({
      squaredDifferenceStrict_: function(t, e) {
        ...
        return (
          f(n.shape, r.shape, 'Error in squaredDifferenceStrict: '),
    ...
    js = ge({
      subStrict_: function(t, e) {
        var n = me(t, 'a', 'subStrict'),
          r = me(e, 'b', 'subStrict');
        return f(n.shape, r.shape, 'Error in subStrict: '), n.sub(r);
      },
    });
  var $s = ge({
    ...
    Ys = ge({
      logicalXor_: function(t, e) {
        ...
        return Je(n.shape, r.shape), Xs(t, e).logicalAnd($s(t, e).logicalNot());
      },
    }),
    Qs = ge({
      where_: function(t, e, n) {
        ...
        return (
          f(r.shape, o.shape, 'Error in where: '),
          1 === i.rank
            ? A(
                i.shape[0] === r.shape[0],
                'The first dimension of `a` must match the size of `condition`.'
              )
            : f(i.shape, o.shape, 'Error in where: '),
          Ft.engine.runKernel(
            function(t) {
    ...
    eu = ge({
      prelu_: function(t, e) {
        var n = me(t, 'x', 'prelu'),
          r = me(e, 'alpha', 'prelu'),
          o = Se(0);
        return Ms(o, n).add(r.mul(Fs(o, n)));
      },
    }),
    nu = ge({
      relu_: function(t) {
  ...
  var iu = ge({
    localResponseNormalization_: function(t, r, o, i, a) {
      ...
      var s = e,
        n = !1;
      3 === e.rank &&
        ((n = !0), (s = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])));
      var u = Ft.engine.runKernel(
        function(t, e) {
        ...
        function(e, t) {
          ...
          return {
            x4D: function() {
              return Ft.engine.runKernel(function(t) {
  ...
  var cu = ge({
        ...
        return (
          ...
          Ft.engine.runKernel(
            ...
            function(m) {
              return {
                $x: function() {
                  if (0 === v) return lu(m, y, g.shape[v]);
                  var t = g.shape,
                    e = y.size,
                    n = t.slice(0, v),
                    r = n.length,
    ...
    lu = ge({
      unsortedSegmentSum_: function(t, e, n) {
        ...
        return (
          A(D(n), 'numSegments must be of dtype int'),
          Ft.engine.runKernel(
            function(t) {
  ...
  var hu = ge({
    ...
    pu = ge({
      multiRNNCell_: function(t, e, n, r) {
        for (
          var o = me(e, 'data', 'multiRNNCell'),
            i = ve(n, 'c', 'multiRNNCell'),
            a = ve(r, 'h', 'multiRNNCell'),
            s = o,
            u = [],
            c = 0;
          c < t.length;
  ...
  var fu = ge({
    movingAverage_: function(t, e, n, r, o) {
      ...
      var i,
        a,
        s = me(t, 'v', 'movingAverage'),
        u = me(e, 'x', 'movingAverage'),
        c = me(n, 'decay', 'movingAverage');
      (a = u),
        A(
          (i = s).dtype === a.dtype,
    ...
    wu = ge({
      irfft_: function(t) {
        ...
        var i = [n, 2 * (e - 1)],
          ...
          l = a.concat(u, 1),
          h = s.concat(c, 1);
        return (r = we(l, h).as2D(i[0], i[1])), (o = yu(r)), be(o);
      },
    }),
    bu = Object.freeze({ fft: gu, ifft: yu, rfft: xu, irfft: wu });
  var Eu = ge({
  ...
  var Ru = ge({
    ...
    Nu = ge({
      computeWeightedLoss_: function(t, e, n) {
        ...
        if (n === Cu.NONE) return i;
        if (n === Cu.SUM) return i.sum();
        if (n === Cu.MEAN) {
        ...
        if (null == o) return i.sum().div(Se(r.size));
        var u = o
          .mul(Ie(r.shape))
          .notEqual(Se(0))
          .sum()
    ...
    Mu = ge({
      sigmoidCrossEntropy_: function(t, e, n, r, o) {
        ...
        var i = me(t, 'multiClassLabels', 'sigmoidCrossEntropy'),
          ...
          s = null;
        if (
          (null != n && (s = me(n, 'weights', 'sigmoidCrossEntropy')),
    ...
    Ou = ge({
      softmaxCrossEntropy_: function(t, e, n, r, o) {
        ...
        var i = me(t, 'onehotLabels', 'softmaxCrossEntropy'),
          ...
          s = null;
        if (
          (null != n && (s = me(n, 'weights', 'softmaxCrossEntropy')),
          ...
          return Lt(function(n, t) {
            ...
            return {
              ...
              gradFunc: function(t) {
                var e = Zt(t.shape, [o]);
                return [
                  t.reshape(e).mul(n.toFloat().sub(r.exp())),
                  t.reshape(e).mul(r.exp().sub(n.toFloat())),
                ];
              },
            };
          })(t, e);
    ...
    Fu = Object.freeze({
      ...
      softmaxCrossEntropy: Ou,
    });
  function Pu(r, o) {
    return (
      void 0 === o && (o = !1),
      Ft.engine.tidy(function() {
        if (2 !== r.shape.length)
          throw new Error(
          ...
          var h = r.shape[0],
            ...
            e = function(l) {
              ...
              (v = (t = Ft.engine.tidy(function() {
                ...
                d =
                  0 === l
                    ? s.sub(u.matMul(v.transpose().matMul(s)))
                    : d
                        .slice([0, 0], [l, p])
                        .concat(s.sub(u.matMul(v.transpose().matMul(s))), 0);
                var c = f.slice([0, l], [h, f.shape[1] - l]);
                return (
                  (f =
                    0 === l
                      ? c.sub(c.matMul(v).matMul(u.transpose()))
                      : f
                          .slice([0, 0], [h, l])
                          .concat(c.sub(c.matMul(v).matMul(u.transpose())), 1)),
                  [v, d, f]
                );
              }))[0]),
                (d = t[1]),
  ...
  var Bu = ge({
    ...
    Wu = Object.freeze({ gramSchmidt: Bu, qr: Lu });
        ...
        m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            switch (t.label) {
              case 0:
                return (
                  (e = me(s, 'boxes', 'nonMaxSuppressionAsync')),
      ...
      return (
        ...
        (t.prototype.fromPixels = function(t, e) {
          if (null == t)
            throw new Error('pixels passed to tf.fromPixels() can not be null');
          var n, r;
          if (Ft.get('IS_NODE') && null == t.getContext)
            throw new Error(
          ...
          if (null != t.getContext)
            ...
            if (
              !(t instanceof HTMLImageElement || t instanceof HTMLVideoElement)
            )
              throw new Error(
                'pixels passed to tf.fromPixels() must be either an HTMLVideoElement, HTMLImageElement, HTMLCanvasElement or ImageData, but was ' +
                  t.constructor.name
        ...
        (t.prototype.readSync = function(t) {
          var e = this.data.get(t),
            ...
            r = e.complexTensors;
          return 'complex64' === n
            ? Ve(r.real.dataSync(), r.imag.dataSync())
        ...
        (t.prototype.stridedSlice = function(t, e, n, r, o, i, a, s, u) {
          ...
          for (var d = ii(h, t.dtype), m = 0; m < d.size; m++) {
            for (
              var v = d.indexToLoc(m), g = new Array(v.length), y = 0;
              y < g.length;
              y++
            )
              g[y] = v[y] * r[y] + l[y];
        ...
        (t.prototype.neg = function(t) {
          return this.assertNotComplex(t, 'neg'), this.multiply(Se(-1), t);
        }),
        (t.prototype.add = function(t, e) {
          return 'complex64' === t.dtype || 'complex64' === e.dtype
            ...
            : this.broadcastedBinaryOp(t, e, xt(t.dtype, e.dtype), function(
                t,
                e
              ) {
                return t + e;
        ...
        (t.prototype.logicalNot = function(t) {
          ...
          for (
            ...
            n[r] = e[r] ? 0 : 1;
          return it.make(t.shape, { values: n }, 'bool');
        }),
        (t.prototype.logicalAnd = function(t, e) {
          return (
        ...
        (t.prototype.select = function(t, e, n) {
          ...
          for (
            var r = t.dataSync(),
              o = e.dataSync(),
              i = n.dataSync(),
              a = Ae(e.shape, xt(e.dtype, n.dtype)),
              s = a.dataSync(),
              u = 0,
        ...
        (t.prototype.ceil = function(t) {
          ...
          for (
            ...
            n[r] = Math.ceil(e[r]);
          return it.make(t.shape, { values: n });
        }),
        (t.prototype.floor = function(t) {
        ...
        (t.prototype.elu = function(t) {
          ...
          return it.make(t.shape, { values: e });
        }),
        (t.prototype.eluDer = function(t, e) {
          ...
          return it.make(e.shape, { values: n });
        }),
        (t.prototype.selu = function(t) {
        ...
        (t.prototype.clip = function(t, e, n) {
          ...
          return it.make(t.shape, { values: r });
        }),
        (t.prototype.abs = function(t) {
          for (
            var e = new Float32Array(t.size), n = t.dataSync(), r = 0;
        ...
        (t.prototype.int = function(t) {
          ...
          for (
            ...
            e[r] = n[r];
          return it.make(t.shape, { values: e }, 'int32');
        }),
        (t.prototype.sigmoid = function(t) {
        ...
        (t.prototype.conv2d = function(t, e, n) {
          ...
          for (
            ...
            for (
              var d = f * t.strides[0], m = f * c.strides[0], v = 0;
              v < n.outHeight;
              ++v
            )
              for (
                var g = m + v * c.strides[1], y = v * n.strideHeight - s, x = 0;
                x < r;
                x++
              ) {
                var w = y + x * i;
                    ...
                    for (
                      ...
                      if (!(N < 0 || N >= n.inWidth))
                        for (
                          ...
                          for (var A = l[T + I], M = 0; M < n.outChannels; ++M)
                            p[S + M] += A * h[D + M];
                          D += n.outChannels;
                        }
                    }
        ...
        (t.prototype.conv3d = function(t, e, n) {
          for (
            ...
            for (
              var g = v * t.strides[0], y = v * p.strides[0], x = 0;
              x < n.outDepth;
              ++x
            )
              for (
                ...
                if (!(C < 0 || C >= n.inDepth))
                  for (
                    var S = E * e.strides[0], _ = g + C * t.strides[1], R = 0;
                    R < n.outHeight;
                    ++R
                  )
                    for (
              ...
              for (var O = 0; O < C; ++O)
                for (
                  ...
                  for (
                    ...
                    for (var H = G * k - F, q = z; q < U; ++q)
                      for (
                        var j = h * A + p * G + f * q,
                          $ =
                            v * (w - 1 - H) + g * (b - 1 - (q * T - W)) + y * M,
                          K = 0;
                        K < _;
                        ++K
                      )
        ...
        (t.prototype.conv3dDerInput = function(t, e, n) {
          for (
            var r = ii(n.inShape, 'float32'),
              ...
              F = n.strideHeight,
              P = n.strideWidth,
              B = C - 1 - n.padInfo.front,
              L = S - 1 - n.padInfo.top,
              W = _ - 1 - n.padInfo.left,
              z = 0;
            z < E;
            ++z
          )
                ...
                for (
                  ...
                  for (
                    ...
                    for (
                      ...
                      for (var nt = et * O - G, rt = K; rt < X; ++rt)
                        for (var ot = rt * F - $, it = J; it < Z; ++it)
                          for (
                            var at = p * z + f * et + d * rt + m * it,
                              st =
                                y * (C - 1 - nt) +
                                x * (S - 1 - ot) +
                                w * (_ - 1 - (it * P - Q)) +
        ...
        (t.prototype.conv2dDerFilter = function(t, e, n) {
          ...
          for (
            ...
            for (
              var h = Math.max(0, Math.ceil((c - l) / r)),
                p = Math.min(n.outHeight, (n.inHeight + c - l) / r),
                f = 0;
              f < a;
              ++f
            )
              for (
                var d = Math.max(0, Math.ceil((u - f) / o)),
                  m = Math.min(n.outWidth, (n.inWidth + u - f) / o),
                  v = 0;
                v < n.inChannels;
                ++v
              )
        ...
        (t.prototype.conv3dDerFilter = function(t, e, n) {
          for (
            ...
            for (
              var A = Math.max(0, Math.ceil((k - I) / r)),
                M = Math.min(n.outDepth, (n.inDepth + k - I) / r),
                O = I * p,
                F = 0;
              F < s;
              ++F
              ...
              for (
                var P = Math.max(0, Math.ceil((D - F) / o)),
                  B = Math.min(n.outHeight, (n.inHeight + D - F) / o),
                  L = F * f + O,
                  W = 0;
                W < u;
                ++W
                ...
                for (
                  var z = Math.max(0, Math.ceil((T - W) / i)),
                    U = Math.min(n.outWidth, (n.inWidth + T - W) / i),
                    V = W * d + L,
                    G = 0;
                  G < n.inChannels;
                  ++G
        ...
        (t.prototype.depthwiseConv2D = function(t, e, n) {
          ...
          for (
            ...
            for (
              ...
              for (
                var y = v + g * l.strides[1], x = g * n.strideHeight - s, w = 0;
                w < r;
                ++w
              ) {
                var b = x + w * i;
                if (!(b < 0 || b >= n.inHeight))
                  for (
                    var E = w * e.strides[0], C = m + b * t.strides[1], S = 0;
                    S < n.outWidth;
                    ++S
                  )
                    for (
                      var _ = y + S * l.strides[2],
                        R = S * n.strideWidth - u,
                        N = 0;
                      N < o;
                      ++N
          ...
          for (
            ...
            for (
              var p = Math.max(0, Math.ceil((c - h) / r)),
                f = Math.min(n.outHeight, (n.inHeight + c - h) / r),
                d = 0;
              d < a;
              ++d
            )
              for (
                var m = Math.max(0, Math.ceil((u - d) / o)),
                  v = Math.min(n.outWidth, (n.inWidth + u - d) / o),
                  g = 0;
                g < n.outChannels;
                ++g
              ) {
                for (
                  var y = Math.trunc(g / l), x = g % l, w = 0, b = 0;
                  b < n.batchSize;
                  ++b
                )
                  for (var E = p; E < f; ++E)
              ...
              for (var E = 0; E < e.outHeight; ++E)
                for (
                  ...
                  for (
                    ...
                    for (var F = w + O * t.strides[1], P = T; P < D; P += a) {
                      var B = p[F + P * t.strides[2] + b];
                      'max' === n && I < B
                        ? (I = B)
                        : 'avg' === n && ((A += B), M++);
                    }
          ...
          for (
            ...
            for (var p = 0; p < e.inChannels; ++p)
              for (var f = 0; f < e.outHeight; ++f) {
                for (var d = f * r - c, m = d; m < 0; ) m += i;
                for (
                  var v = Math.min(e.inHeight, s + d), g = 0;
                  g < e.outWidth;
                  ++g
                ) {
                  for (var y = g * o - l, x = y; x < 0; ) x += a;
                  for (
              ...
              for (
                ...
                for (
                  ...
                  for (var A = 0, M = 0; M < x; M++) {
                    var O = M + R;
                    if (!(O < 0 || c <= O)) {
                      var F = E + O * t.strides[1],
                        P = O * m;
                      if (
                        C === Math.min(i - 1, n ? Math.round(P) : Math.floor(P))
                      )
                        for (var B = 0; B < w; B++) {
                          var L = B + D;
                          if (!(L < 0 || l <= L)) {
        ...
        (t.prototype.batchNormalization = function(t, e, n, r, o, i) {
          ...
          for (
            ...
            (h[w] =
              l[v++] + ((a[w] - s[g++]) * c[y++]) / Math.sqrt(u[x++] + r)),
              p <= v && (v = 0),
              m <= g && (g = 0),
              f <= y && (y = 0),
              d <= x && (x = 0);
        ...
        (t.prototype.fftBatch = function(t, e) {
          for (
            var n = t.shape[0],
              r = t.shape[1],
              o = ii(t.shape, 'float32'),
              i = ii(t.shape, 'float32'),
              a = be(t).as2D(n, r),
              s = Ee(t).as2D(n, r),
              u = 0;
            u < n;
        ...
        (t.prototype.fftImpl = function(t, e) {
          ...
          if (this.isExponentOf2(r)) {
            ...
            return e && (o = we(be(o).div(Se(r)), Ee(o).div(Se(r)))), o;
          }
          var i = t.dataSync(),
            a = (function(t) {
              for (
          ...
          for (var r = new Float32Array(2 * e), o = 0; o < e; o++) {
            for (var i = 0, a = 0, s = 0; s < e; s++) {
              var u = ((d = o * s),
                ...
                void 0,
                (v = (n ? 2 : -2) * Math.PI * (d / m)),
                { real: Math.cos(v), imag: Math.sin(v) }),
                c = Ge(t, s);
          ...
          for (
            ...
            for (var d = 0; d < s; ++d)
              for (var m = Math.floor(d / e), v = d % e, g = 0; g < u; ++g)
                for (
                  var y = Math.floor(g / e), x = (v * e + (g % e)) * c, w = 0;
                  w < c;
                  ++w
                ) {
        ...
        (t.prototype.cropAndResize = function(t, e, n, r, o, i) {
          for (
            ...
            if (!(s <= R))
              for (
                var N = 1 < p ? ((S - E) * (u - 1)) / (p - 1) : 0,
                  k = 1 < f ? ((_ - C) * (c - 1)) / (f - 1) : 0,
                  T = 0;
                T < p;
                T++
              ) {
                var D = 1 < p ? E * (u - 1) + T * N : 0.5 * (E + S) * (u - 1);
                if (D < 0 || u - 1 < D)
                  for (var I = 0; I < f; I++)
                    for (var A = 0; A < l; A++) {
                      var M = A + I * x[2] + T * x[1] + w * x[0];
                      d.values[M] = i;
                    }
                else if ('bilinear' === o) {
                  var O = Math.floor(D),
                  ...
                  for (I = 0; I < f; I++)
                    if (
                      (q =
                        1 < f ? C * (c - 1) + I * k : 0.5 * (C + _) * (c - 1)) <
                        0 ||
                      c - 1 < q
                    )
                      for (A = 0; A < l; A++)
                        (M = A + I * x[2] + T * x[1] + w * x[0]),
                          (d.values[M] = i);
                    else {
                      var B = Math.floor(q),
                        L = Math.ceil(q),
                        W = q - B;
                      for (A = 0; A < l; A++) {
                        var z = g[(M = A + B * y[2] + O * y[1] + R * y[0])],
                          U = g[(M = A + L * y[2] + O * y[1] + R * y[0])],
                          V = g[(M = A + B * y[2] + F * y[1] + R * y[0])],
                          G = z + (U - z) * W,
                          H =
                            V +
                            (g[(M = A + L * y[2] + F * y[1] + R * y[0])] - V) *
                              W;
                        (M = A + I * x[2] + T * x[1] + w * x[0]),
                          (d.values[M] = G + (H - G) * P);
                      }
        ...
        (t.prototype.gatherND = function(t, e) {
          var n = e.shape,
            ...
            s = o[2],
            u = o[3];
          if (0 === a) return Ce([], i, t.dtype);
          for (
            var c = new et([a, s], t.dtype),
              l = e.dataSync(),
              h = t.dataSync(),
              p = 0;
            p < a;
        ...
        (t.prototype.scatter = function(t, e, n, r, o, i, a, s, u, c) {
          ...
          for (var d = 0; d < i; d++) {
            ...
            for (var x = 0; x < o; x++)
              c
                ? (f.values[v * o + x] += p[d * o + x])
                : (f.values[v * o + x] = 0 === e.rank ? p[0] : p[d * o + x]);
          }
  ...
  var Xu =
    'undefined' != typeof requestAnimationFrame
      ...
      : setImmediate;
  var Yu = { float32: 4, int32: 4, uint16: 2, uint8: 1, bool: 1 };
  function Qu(p, t) {
    for (
      var f = {},
        d = 0,
        e = function(t) {
          ...
          var h = void 0;
          if ('float32' === n) h = Ce(i, r, 'float32');
          else if ('int32' === n) h = Ce(i, r, 'int32');
          else {
            if ('bool' !== n)
  ...
  function nc(t) {
    ...
    return {
      ...
      modelTopologyBytes:
        null == t.modelTopology ? 0 : Zu(JSON.stringify(t.modelTopology)),
      weightSpecsBytes:
        null == t.weightSpecs ? 0 : Zu(JSON.stringify(t.weightSpecs)),
  ...
  function ac(t) {
    ...
    return { scheme: t.split(oc)[0], path: t.split(oc)[1] };
  }
  function sc(l, h, p) {
    return (
      void 0 === p && (p = !1),
      m(this, void 0, void 0, function() {
        ...
        return C(this, function(t) {
          switch (t.label) {
            case 0:
              return (
                A(l !== h, "Old path and new path are the same: '" + l + "'"),
                A(
                  0 < (e = rc.getLoadHandlers(l)).length,
                ...
                (n = e[0]),
                A(
                  0 < (r = rc.getSaveHandlers(h)).length,
  ...
  function pc(t) {
    var e = t.result;
    e.createObjectStore(cc, { keyPath: 'modelPath' }),
      e.createObjectStore(lc, { keyPath: 'modelPath' });
  }
  var fc = (function() {
      function t(t) {
        if (((this.indexedDB = hc()), null == t || !t))
          throw new Error(
              ...
              (l.onsuccess = function() {
                ...
                if (null == h) {
                  ...
                  (n.onsuccess = function() {
                    var n = (o = r.transaction(cc, 'readwrite'))
                      .objectStore(cc)
                      .put({
                        modelPath: p.modelPath,
                        modelArtifacts: h,
    ...
    dc = function(t) {
      return Ft.get('IS_BROWSER') &&
        !Array.isArray(t) &&
        t.startsWith(fc.URL_SCHEME)
        ? ((e = t.slice(fc.URL_SCHEME.length)), new fc(e))
        : null;
      var e;
    };
  rc.registerSaveRouter(dc), rc.registerLoadRouter(dc);
  var mc = (function() {
    function t() {
      this.indexedDB = hc();
    }
    return (
      ...
      (t.prototype.removeModel = function(u) {
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            return (
              (u = (e = u).startsWith(fc.URL_SCHEME)
                ? e.slice(fc.URL_SCHEME.length)
                : e),
              [
                2,
                  ...
                  (e.onupgradeneeded = function() {
                    ...
                    (e.onsuccess = function() {
                      ...
                      (i.onsuccess = function() {
                        ...
                        var t = o.delete(u),
                          e = function() {
                            var t = (n = r.transaction(cc, 'readwrite'))
                              .objectStore(cc)
                              .delete(u);
  ...
  var Sc = (function() {
      function t(t) {
        if (!Ft.get('IS_BROWSER') || void 0 === window.localStorage)
          throw new Error(
        ...
        (this.modelPath = t), (this.keys = Ec(this.modelPath));
      }
      return (
        (t.prototype.save = function(a) {
          return m(this, void 0, void 0, function() {
            var n, r, o, i;
            return C(this, function(t) {
    ...
    _c = function(t) {
      return Ft.get('IS_BROWSER') &&
        !Array.isArray(t) &&
        t.startsWith(Sc.URL_SCHEME)
        ? ((e = t.slice(Sc.URL_SCHEME.length)), new Sc(e))
        : null;
      var e;
    };
  rc.registerSaveRouter(_c), rc.registerLoadRouter(_c);
  var Rc = (function() {
    function t() {
      A(Ft.get('IS_BROWSER'), 'Current environment is not a web browser'),
        A(
    ...
    return (
      (t.prototype.listModels = function() {
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            for (
              e = {}, n = gc + vc, r = vc + yc, o = 0;
              o < this.LS.length;
              ++o
            )
              (i = this.LS.key(o)).startsWith(n) &&
                i.endsWith(r) &&
                ((a = Cc(i)), (e[a] = JSON.parse(this.LS.getItem(i))));
            return [2, e];
          });
        });
      }),
      (t.prototype.removeModel = function(o) {
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            if (
              ((o = (e = o).startsWith(Sc.URL_SCHEME)
                ? e.slice(Sc.URL_SCHEME.length)
                : e),
              (n = Ec(o)),
          ...
          return m(this, void 0, void 0, function() {
            ...
            return C(this, function(t) {
              ...
              return (
                ...
                (r = { modelTopology: s.modelTopology, weightsManifest: n }),
  ...
  rc.registerSaveRouter(function(t) {
    return Ft.get('IS_BROWSER') &&
      !Array.isArray(t) &&
      t.startsWith(Nc.URL_SCHEME)
      ? (void 0 === (e = t.slice(Nc.URL_SCHEME.length)) && (e = 'model'),
        new Nc(e))
      : null;
    var e;
  });
            ...
            switch (t.label) {
              case 0:
                ...
                return (
                  ...
                  (r = { modelTopology: i.modelTopology, weightsManifest: n }),
                  e.body.append(
                    'model.json',
                    new Blob([JSON.stringify(r)], { type: 'application/json' }),
                    'model.json'
              ...
              case 1:
                if ((o = t.sent()).ok)
                  return [2, { modelArtifactsInfo: nc(i), responses: [o] }];
                throw new Error(
        ...
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            switch (t.label) {
              ...
              case 2:
                return (r = t.sent()), (o = r[0]), [4, r[1].json()];
              case 3:
                return null == (i = t.sent())
                  ? [3, 5]
                  : [4, this.loadWeights(i)];
              case 4:
                (u = t.sent()), (a = u[0]), (s = u[1]), (t.label = 5);
              case 5:
          ...
          return C(this, function(t) {
            switch (t.label) {
              ...
              case 2:
                ...
                return null == o
                  ? [3, 4]
                  : ((s = n.weightsManifest), [4, this.loadWeights(s)]);
              case 3:
                (u = t.sent()), (i = u[0]), (a = u[1]), (t.label = 4);
              case 4:
                return [2, { modelTopology: r, weightSpecs: i, weightData: a }];
            }
          });
        });
      }),
            ...
            switch (t.label) {
              case 0:
                ...
                return (
                  ...
                  (d = [c]),
                  (m = tc),
                  [4, Tc(f, this.requestInit, this.getFetchFunc())]
                );
              case 1:
  ...
  rc.registerSaveRouter(Mc), rc.registerLoadRouter(Mc);
  var Fc = (function() {
      function t(t, e, n) {
        ...
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            switch (t.label) {
              ...
              case 1:
                return r < o.length
                  ? ((i = o[r]), [4, ic.getManager(i).listModels()])
                  : [3, 4];
              case 2:
                for (s in (a = t.sent())) n[i + oc + s] = a[s];
                t.label = 3;
              case 3:
                return r++, [3, 1];
              case 4:
        ...
        return m(this, void 0, void 0, function() {
          ...
          return C(this, function(t) {
            switch (t.label) {
              case 0:
                return (
                  (e = ac(n)), [4, ic.getManager(e.scheme).removeModel(e.path)]
                );
              case 1:
                return [2, t.sent()];
            }
  ...
  var Vc = ge({
    ...
    Gc = Object.freeze({ confusionMatrix: Vc }),
    Hc = (function() {
      function t() {}
      return (
  ...
  function Xc(t, e, n) {
    ...
    var i, a;
    if (
      ((i = t instanceof it ? t.dataSync() : t),
  ...
  var Qc = Object.freeze({
      ...
      expectArraysEqual: function(t, e) {
        return (t instanceof it && 'string' === t.dtype) ||
          (e instanceof it && 'string' === e.dtype) ||
          (t instanceof Array && F(t[0])) ||
          (e instanceof Array && F(e[0]))
          ? Xc(t, e, function(t, e) {
              return t == e;
            })
          : Kc(t, e, 0);
      ...
      expectNumbersClose: function(t, e, n) {
        if ((null == n && (n = Ft.get('TEST_EPSILON')), !Yc(t, e, n)))
          throw new Error(
    ...
    tl = (function(o) {
      ...
      return (
        ...
        (t.prototype.applyGradients = function(t) {
          var c = this,
            e = function(o) {
              var i = Ft.engine.registeredVariables[o];
  ...
  var el = (function(r) {
    function t(t, e) {
      ...
      return (
        ...
        (n.accumulatedGrads = {}),
        (n.c = Ut(Se(-t))),
        (n.epsilon = Ut(Se(Ft.get('EPSILON')))),
        n
      );
    }
    return (
      ...
      (t.prototype.applyGradients = function(t) {
        var a = this,
          e = function(n) {
            var r = Ft.engine.registeredVariables[n];
            null == s.accumulatedGrads[n] &&
              zt(function() {
                a.accumulatedGrads[n] = Me(
                  r.shape,
  ...
  var nl = (function(i) {
    function t(t, e, n, r) {
      ...
      return (
        ...
        zt(function() {
          (o.accBeta1 = Se(e).variable()), (o.accBeta2 = Se(n).variable());
        }),
        (o.oneMinusBeta1 = Ut(Se(1 - e))),
        (o.oneMinusBeta2 = Ut(Se(1 - n))),
        (o.one = Ut(Se(1))),
        null === r && (r = Ft.get('EPSILON')),
        (o.epsScalar = Ut(Se(r))),
        o
      );
    }
        ...
        zt(function() {
          ...
          for (var n in f) {
            ...
            null == d.accumulatedSecondMoment[n] &&
              ((o = !1), (d.accumulatedSecondMoment[n] = Be(r).variable(o)));
            var i = f[n],
  ...
  var rl = (function(a) {
    function t(t, e, n, r, o) {
      ...
      return (
        ...
        zt(function() {
          (i.iteration = Se(0).variable()), (i.accBeta1 = Se(e).variable());
        }),
        ...
        zt(function() {
          ...
          for (var n in f) {
            ...
            null == d.accumulatedWeightedInfNorm[n] &&
              ((o = !1), (d.accumulatedWeightedInfNorm[n] = Be(r).variable(o)));
            var i = f[n],
              a = d.accumulatedFirstMoment[n],
    ...
    return (
      ...
      (t.prototype.applyGradients = function(r) {
        ...
        Object.keys(r).forEach(function(t) {
          var e = r[t],
            n = Ft.engine.registeredVariables[t];
          zt(function() {
  ...
  var al = (function(a) {
    ...
    return (
      ...
      (t.prototype.applyGradients = function(t) {
        var h = this,
          e = function(i) {
            var a = Ft.engine.registeredVariables[i];
  ...
  var sl = (function() {
      ...
      return (
        ...
        (t.momentum = function(t, e, n) {
          return void 0 === n && (n = !1), new il(t, e, n);
        }),
        ...
        (t.adagrad = function(t, e) {
          return void 0 === e && (e = 0.1), new el(t, e);
        }),
        t
      );
    })(),
  ...
  var fl = Object.freeze({
      ...
      grad: function(i) {
        return (
          A(W(i), 'The f passed in grad(f) must be a function'),
          function(r, o) {
            return (
              A(r instanceof it, 'The x passed in grad(f)(x) must be a tensor'),
              A(
                null == o || o instanceof it,
                'The dy passed in grad(f)(x, dy) must be a tensor'
              ),
              Ft.engine.tidy(function() {
                var t = Ft.engine.gradients(
                    function() {
                      return i(r);
                    },
                    [r],
      ...
      grads: function(i) {
        return (
          A(W(i), 'The f passed in grads(f) must be a function'),
          function(r, o) {
            return (
              A(
                Array.isArray(r) &&
      ...
      valueAndGrad: function(i) {
        return (
          A(W(i), 'The f passed in valueAndGrad(f) must be a function'),
          function(t, e) {
            A(
              t instanceof it,
              ...
              A(
                null == e || e instanceof it,
                'The dy passed in valueAndGrad(f)(x, dy) must be a tensor'
              );
            var n = Ft.engine.gradients(
                function() {
                  return i(t);
                },
                [t],
              ...
              r = n.grads,
              o = n.value;
            return Wt(r), { grad: r[0], value: o };
          }
        );
      },
      valueAndGrads: function(r) {
        return (
          A(W(r), 'The f passed in valueAndGrads(f) must be a function'),
          function(t, e) {
            A(
              Array.isArray(t) &&
                t.every(function(t) {
  ...
  function Tl(t, e) {
    var n = t.width,
      r = t.height,
      o = e / Math.max(r, n);
    return new xl(Math.round(n * o), Math.round(r * o));
  }
  function Dl(t) {
    return t
      .reduce(function(t, e) {
  ...
  var Ol,
    Fl = (function() {
      function l(t, e) {
        void 0 === e && (e = !1);
        var n = t || {},
          r = [n.left, n.top, n.right, n.bottom].every(Al),
          o = [n.x, n.y, n.width, n.height].every(Al);
        if (!o && !r)
          throw new Error(
      ...
      return (
        (l.isRect = function(t) {
          return !!t && [t.x, t.y, t.width, t.height].every(Al);
        }),
    ...
    Pl = (function(o) {
      function t(t, e, n, r) {
        return o.call(this, { left: t, top: e, right: n, bottom: r }) || this;
      }
      return ml(t, o), t;
    })(Fl),
    Bl = (function(r) {
    ...
    Ll = (function(r) {
      ...
      return (
        ...
        (t.assertIsValidLabeledBox = function(t, e) {
          if ((Fl.assertIsValidBox(t, e), !Al(t.label)))
            throw new Error(
    ...
    Wl = (function() {
      function n(t, e, n, r, o) {
        (this._imageDims = new xl(o.width, o.height)),
          (this._score = t),
          (this._classScore = e),
          (this._className = n),
          (this._box = new Fl(r).rescale(this._imageDims));
      }
      return (
        ...
        Object.defineProperty(n.prototype, 'relativeBox', {
          get: function() {
            return new Fl(this._box).rescale(this.imageDims.reverse());
          },
          enumerable: !0,
          configurable: !0,
        }),
    ...
    zl = (function(i) {
      ...
      return (
        ...
        (t.assertIsValidPredictedBox = function(t, e) {
          if (
            (Ll.assertIsValidLabeledBox(t, e),
            !Ml(t.score) || !Ml(t.classScore))
          )
            throw new Error(
              e +
    ...
    Ul = (function(o) {
      function t(t, e, n, r) {
        return o.call(this, { x: t, y: e, width: n, height: r }) || this;
      }
      return ml(t, o), t;
    })(Fl);
  function Vl(t, n) {
  ...
  var Zl = {
    ...
    monkeyPatch: function(t) {
      ...
      var e = t.Canvas,
        n = void 0 === e ? Ol.Canvas : e,
        r = t.Image,
        o = void 0 === r ? Ol.Image : r;
      (Ol.Canvas = n),
        (Ol.Image = o),
        (Ol.createCanvasElement =
          t.createCanvasElement ||
          function() {
            return new n();
          }),
        (Ol.createImageElement =
          t.createImageElement ||
          function() {
            return new o();
          }),
        (Ol.ImageData = t.ImageData || Ol.ImageData),
        (Ol.Video = t.Video || Ol.Video),
        (Ol.fetch = t.fetch || Ol.fetch),
        (Ol.readFile = t.readFile || Ol.readFile);
    },
    isBrowser: Xl,
    isNodejs: Yl,
  };
  ...
  function eh(t) {
    return new Promise(function(e, n) {
      if (t instanceof Zl.getEnv().Canvas || th(t)) return e();
      function r(t) {
        t.currentTarget &&
  ...
  function nh(t) {
    return new Promise(function(e, n) {
      ...
      (r.onload = function() {
        ...
        var t = Zl.getEnv().createImageElement();
        (t.onload = function() {
          return e(t);
        }),
          (t.onerror = n),
  ...
  function oh(t) {
    ...
    return t instanceof n
      ? new xl(t.naturalWidth, t.naturalHeight)
      : t instanceof r
      ? new xl(t.videoWidth, t.videoHeight)
      : new xl(t.width, t.height);
  }
  function ih(t) {
    var e = t.width,
      n = t.height,
      r = (0, Zl.getEnv().createCanvasElement)();
    return (r.width = e), (r.height = n), r;
  }
  function ah(t, e) {
    var n = Zl.getEnv().ImageData;
    if (!(t instanceof n || th(t)))
      throw new Error(
    ...
    var r = e || oh(t),
      o = r.width,
      i = r.height,
      a = ih({ width: o, height: i });
    return (
      t instanceof n
        ? rh(a).putImageData(t, 0, 0)
        : rh(a).drawImage(t, 0, 0, o, i),
      a
    );
  }
  function sh(t) {
  ...
  function ch(t, e, n, r, o) {
    void 0 === o && (o = {});
    var i = Object.assign(sh(), o),
      a = 2 + i.lineWidth;
    (t.fillStyle = i.textColor),
      (t.font = i.fontSize + 'px ' + i.fontStyle),
      t.fillText(r, e + a, n + a + 0.6 * i.fontSize);
  }
  function lh(t) {
    return Zl.isNodejs() || 'string' != typeof t
      ? t
  ...
  function hh(n, r) {
    return gl(this, void 0, void 0, function() {
      ...
      return yl(this, function(t) {
        switch (t.label) {
          case 0:
            return [4, (0, Zl.getEnv().fetch)(n, r)];
          case 1:
    ...
    return gl(this, void 0, void 0, function() {
      ...
      return yl(this, function(t) {
        switch (t.label) {
          case 0:
            return (
              (e = u || Zl.getEnv().createCanvasElement()),
              (n = s.shape.slice(Sl(s) ? 1 : 0)),
              (r = n[0]),
              (o = n[1]),
              (i = n[2]),
              [
  ...
  function dh(t, e, n) {
    ...
    var a = oh(t),
      ...
      u = s * a.width,
      c = s * a.height,
      l = ih({ width: e, height: e }),
      h = t instanceof i ? t : ah(t),
      p = Math.abs(u - c) / 2,
      f = n && u < c ? p : 0,
      d = n && c < u ? p : 0;
    return rh(l).drawImage(h, f, d, u, c), l;
  }
  function mh(t) {
    var e = Zl.getEnv(),
      n = e.Image,
    ...
    return gl(this, void 0, void 0, function() {
      ...
      return yl(this, function(t) {
        switch (t.label) {
          ...
          case 1:
            return (o = t.sent()), [2, Uc.loadWeights(o, r)];
        }
      });
    });
  }
  ...
  var yh = (function() {
    function t(t, e) {
      ...
      (this._treatAsBatchInput = e),
        ...
        t.forEach(function(t, e) {
          ...
          var r = t instanceof Zl.getEnv().Canvas ? t : ah(t);
          (o._canvases[e] = r),
    ...
    return (
      ...
      Object.defineProperty(t.prototype, 'reshapedInputDimensions', {
        get: function() {
          var n = this;
          return Il(this.batchSize, 0, 1).map(function(t, e) {
      ...
      (t.prototype.toBatchTensor = function(r, o) {
        ...
        return (
          ...
          (this._inputSize = r),
          zt(function() {
            var t = Il(i.batchSize, 0, 1).map(function(t) {
              var e = i.getInput(t);
              if (e instanceof it) {
                var n = Sl(e) ? e : e.expandDims();
                return (
                  ((n = gh(n, o)).shape[1] === r && n.shape[2] === r) ||
                    (n = ju.resizeBilinear(n, [r, r])),
                  n.as3D(r, r, 3)
                );
              }
              if (e instanceof Zl.getEnv().Canvas) return di(dh(e, r, o));
              throw new Error(
        ...
        switch (t.label) {
          case 0:
            ...
            return (
              ...
              (e = r.map(lh)).forEach(function(t, e) {
                if (!mh(t) && !Cl(t) && !Sl(t)) {
          ...
          case 1:
            return t.sent(), [2, new yh(e, Array.isArray(n))];
        }
      });
    });
  }
  ...
  var Sh = (function() {
            ...
            return yl(this, function(t) {
              switch (t.label) {
                case 0:
                  ...
                  return [4, vh(n, this.getDefaultModelName())];
                case 1:
              ...
              switch (t.label) {
                case 0:
                  ...
                  return (
                    ...
                    (n = ql(h, this.getDefaultModelName())),
                    (r = n.manifestUri),
                    (o = n.modelBaseUri),
                    (i = function(t) {
                      return Promise.all(
    ...
    Rh = (function() {
      function t(t, e, n) {
        void 0 === n && (n = new wl(0, 0));
        var r = e.width,
          o = e.height;
        (this._imgDims = new xl(r, o)),
          (this._shift = n),
          (this._positions = t.map(function(t) {
            return t.mul(new wl(r, o)).add(n);
          }));
      }
      return (
        Object.defineProperty(t.prototype, 'shift', {
          get: function() {
            return new wl(this._shift.x, this._shift.y);
          },
          enumerable: !0,
          configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, 'relativePositions', {
          get: function() {
            ...
            return this._positions.map(function(t) {
              return t.sub(e._shift).div(new wl(e.imageWidth, e.imageHeight));
            });
          },
          enumerable: !0,
          configurable: !0,
        ...
        (t.prototype.align = function(t) {
          if (t) {
            var e = t instanceof _h ? t.box.floor() : t;
          ...
          var n = this.getRefPointsForAlignment(),
            ...
            u = Math.floor(s / 0.45),
            c = Dl(n),
            l = Math.floor(Math.max(0, c.x - 0.5 * u)),
            h = Math.floor(Math.max(0, c.y - 0.43 * u));
          return new Ul(
            l,
            h,
            Math.min(u, this.imageWidth + l),
            Math.min(u, this.imageHeight + h)
          );
        }),
                ...
                u
                  ...
                  .map(function(t) {
                    var e = t.x,
                      ...
                      r = t.width,
                      o = t.height,
                      i = ih({ width: r, height: o });
                    return (
                      rh(i).putImageData(a.getImageData(e, n, r, o), 0, 0), i
                    );
                  }),
              ]
            );
    ...
    return gl(this, void 0, void 0, function() {
      return yl(this, function(t) {
        ...
        return [
          2,
          zt(function() {
            var t = u.shape.slice(Sl(u) ? 1 : 0),
              i = t[0],
              a = t[1],
              s = t[2];
            return e
              .map(function(t) {
                return t instanceof _h ? t.forSize(a, i).box : t;
              })
              .map(function(t) {
  ...
  function Fh(r, o, i) {
    return (
      ...
      zt(function() {
        var t = nu(
            i
              ? Rs(Fa(r, o.conv0.filters, [2, 2], 'same'), o.conv0.bias)
              : Oh(r, o.conv0, [2, 2])
          ),
          e = Oh(t, o.conv1, [1, 1]),
          n = Oh(nu(Rs(t, e)), o.conv2, [1, 1]);
    ...
    return (
      ...
      zt(function() {
        var t = nu(
            a
              ? Rs(
                  Fa(o, i.conv0.filters, s ? [2, 2] : [1, 1], 'same'),
                  i.conv0.bias
                )
              : Oh(o, i.conv0, s ? [2, 2] : [1, 1])
          ),
          e = Oh(t, i.conv1, [1, 1]),
          n = Oh(nu(Rs(t, e)), i.conv2, [1, 1]),
          r = Oh(nu(Rs(t, Rs(e, n))), i.conv3, [1, 1]);
  ...
  function Bh(e, n, r, o) {
    return (
      ...
      void 0 === o && (o = !1),
      zt(function() {
        var t = Rs(Fa(e, n.filters, [1, 1], r), n.bias);
        return o ? nu(t) : t;
      })
    );
  }
  ...
  function Vh(t) {
    if (![t.noObjectScale, t.objectScale, t.coordScale, t.classScale].every(Uh))
      throw new Error(
  ...
  var Gh,
    Hh,
    qh = [3, 16, 32, 64, 128, 256, 512, 1024, 1024];
  function jh(e) {
    return zt(function() {
      var t = Ws(e, Se(0.10000000149011612));
  ...
  function $h(e, n) {
    return zt(function() {
      ...
      return (
        (t = Fa(t, n.conv.filters, [1, 1], 'valid')),
        (t = qs(t, n.bn.sub)),
        (t = Ws(t, n.bn.truediv)),
        jh((t = Rs(t, n.conv.bias)))
      );
    });
  }
  function Kh(e, n) {
    return zt(function() {
      var t = gi(e, [[0, 0], [1, 1], [1, 1], [0, 0]]);
      return (
        (t = Wa(t, n.depthwise_filter, n.pointwise_filter, [1, 1], 'valid')),
        jh((t = Rs(t, n.bias)))
      );
    });
  }
  ...
  function Yh(t, e) {
    ...
    return {
      ...
      extractSeparableConvParams: ((o = n),
      function(t) {
  ...
  var Qh = (function() {
    ...
    Jh = (function(n) {
      function t(t) {
        ...
        return (
          (function(t) {
            ...
            if (!Uh(t.iouThreshold) || t.iouThreshold < 0 || 1 < t.iouThreshold)
              throw new Error(
      ...
      return (
        ...
        (t.prototype.runTinyYolov2 = function(t, e) {
          var n = $h(t, e.conv0);
          return (
            (n = $h((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv1)),
            (n = $h((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv2)),
            (n = $h((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv3)),
            (n = $h((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv4)),
            (n = $h((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv5)),
            Bh(
              (n = $h(
                (n = $h((n = Ka(n, [2, 2], [1, 1], 'same')), e.conv6)),
                e.conv7
              )),
              e.conv8,
              'valid',
        ...
        (t.prototype.runMobilenet = function(t, e) {
          var n = this.config.isFirstLayerConv2d
            ? jh(Bh(t, e.conv0, 'valid', !1))
            : Kh(t, e.conv0);
          return (
            (n = Kh((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv1)),
            (n = Kh((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv2)),
            (n = Kh((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv3)),
            (n = Kh((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv4)),
            (n = Kh((n = Ka(n, [2, 2], [2, 2], 'same')), e.conv5)),
            (n = Ka(n, [2, 2], [1, 1], 'same')),
            (n = e.conv6 ? Kh(n, e.conv6) : n),
            Bh((n = e.conv7 ? Kh(n, e.conv7) : n), e.conv8, 'valid', !1)
          );
        }),
        (t.prototype.forwardInput = function(e, n) {
          ...
          return zt(function() {
            ...
            return (
              (t = (t = r.config.meanRgb ? Eh(t, r.config.meanRgb) : t).div(
                Se(256)
              )),
        ...
        (t.prototype.forward = function(n, r) {
          return gl(this, void 0, void 0, function() {
            ...
            return yl(this, function(t) {
              switch (t.label) {
                case 0:
                  return (e = this.forwardInput), [4, xh(n)];
                case 1:
        ...
        (t.prototype.detect = function(m, v) {
          return (
            void 0 === v && (v = {}),
            gl(this, void 0, void 0, function() {
              var e,
                n,
                r,
                o,
                  ...
                  case 2:
                    return (
                      ...
                      [
                        2,
                        f.map(function(t) {
                          return new Wl(l[t], h[t], p[t], c[t], s);
                        }),
                      ]
                    );
                }
        ...
        (t.prototype.extractParamsFromWeigthMap = function(t) {
          return (function(t, e) {
            ...
            return Vl(t, r), { params: n, paramMappings: r };
          })(t, this.config);
        }),
        (t.prototype.extractParams = function(t) {
          var e = this.config.filterSizes || qh,
            n = e ? e.length : void 0;
          if (7 !== n && 8 !== n && 9 !== n)
            throw new Error(
        ...
        (t.prototype.extractBoxes = function(e, t, n) {
          for (
            var r = this,
              ...
              u = a / i,
              c = e.shape[1],
              l = this.config.anchors.length,
              h = zt(function() {
                var t = e.reshape([c, c, l, r.boxEncodingSize]);
                return [
                  t.slice([0, 0, 0, 0], [c, c, l, 4]),
                  t.slice([0, 0, 0, 4], [c, c, l, 1]),
                  r.withClassScores
                    ? ye(
                        t.slice(
                          [0, 0, 0, 5],
                          [c, c, l, r.config.classes.length]
                        ),
                        3
                      )
                    : Se(0),
            ...
            for (var g = 0; g < c; g++)
              for (var y = 0; y < l; y++) {
                var x = Ch(f.get(v, g, y, 0));
                if (!n || n < x) {
                  var w = ((g + Ch(p.get(v, g, y, 0))) / c) * s,
                    b = ((v + Ch(p.get(v, g, y, 1))) / c) * u,
                    E =
                      ((Math.exp(p.get(v, g, y, 2)) *
                        this.config.anchors[y].x) /
                        c) *
                      s,
                    C =
                      ((Math.exp(p.get(v, g, y, 3)) *
                        this.config.anchors[y].y) /
                        c) *
                      u,
                    S = w - E / 2,
                    _ = b - C / 2,
                    R = { row: v, col: g, anchor: y },
                    N = this.withClassScores
                      ? this.extractPredictedClass(d, R)
    ...
    Zh = (function() {
      function t(t, e, n, r, o) {
        (this._config = o),
          (this._reshapedImgDims = new xl(r.width, r.height)),
          (this._outputTensor = t),
          (this._predictedBoxes = n),
          this.validateGroundTruthBoxes(e),
          (this._groundTruth = this.assignGroundTruthToAnchors(e));
        var i = this.createGroundTruthMask(),
          a = this.createCoordAndScoreMasks(),
          s = a.coordBoxOffsetMask,
          u = a.coordBoxSizeMask,
          c = a.scoreMask;
        (this.noObjectLossMask = zt(function() {
          return Ws(c, qs(Se(1), i));
        })),
          (this.objectLossMask = zt(function() {
            return Ws(c, i);
          })),
          (this.coordBoxOffsetMask = zt(function() {
            return Ws(s, i);
          })),
          (this.coordBoxSizeMask = zt(function() {
            return Ws(u, i);
          }));
        var l = zt(function() {
          return qs(Se(1), s.add(u).add(c));
        });
        this.groundTruthClassScoresMask = zt(function() {
          return Ws(l, i);
        });
      }
      return (
        ...
        Object.defineProperty(t.prototype, 'reshapedImgDims', {
          get: function() {
        ...
        Object.defineProperty(t.prototype, 'outputTensor', {
          get: function() {
        ...
        Object.defineProperty(t.prototype, 'groundTruth', {
          get: function() {
        ...
        Object.defineProperty(t.prototype, 'predictedBoxes', {
          get: function() {
        ...
        Object.defineProperty(t.prototype, 'withClassScores', {
          get: function() {
            return (
              this._config.withClassScores || 1 < this._config.classes.length
            );
          },
          enumerable: !0,
          configurable: !0,
        ...
        Object.defineProperty(t.prototype, 'numBoxes', {
          get: function() {
        ...
        Object.defineProperty(t.prototype, 'numCells', {
          get: function() {
            return this.inputSize / 32;
          },
          enumerable: !0,
          configurable: !0,
        }),
        Object.defineProperty(t.prototype, 'gridCellEncodingSize', {
          get: function() {
        ...
        (t.prototype.toOutputTensorShape = function(t) {
          var e = this;
          return zt(function() {
            return t.reshape([
              1,
        ...
        (t.prototype.computeLoss = function() {
          var i = this;
          return zt(function() {
            var t = i.computeNoObjectLoss(),
              e = i.computeObjectLoss(),
              n = i.computeCoordLoss(),
              r = i.withClassScores ? i.computeClassLoss() : Se(0),
              o = zt(function() {
                return t
                  .add(e)
                  .add(n)
        ...
        (t.prototype.computeNoObjectLoss = function() {
          var t = this;
          return zt(function() {
            return t.computeLossTerm(
              t.config.noObjectScale,
              t.toOutputTensorShape(t.noObjectLossMask),
              oa(t.outputTensor)
            );
          });
        }),
        (t.prototype.computeObjectLoss = function() {
          ...
          return zt(function() {
            return t.computeLossTerm(
              t.config.objectScale,
              t.toOutputTensorShape(t.objectLossMask),
              qs(t.toOutputTensorShape(t.computeIous()), oa(t.outputTensor))
            );
          });
        }),
          ...
          return zt(function() {
            var t = zt(function() {
              var t = Ws(
                  ...
                  n.groundTruthClassScoresMask
                ),
                e = n.createOneHotClassScoreMask();
              return qs(e, t);
            });
            return n.computeLossTerm(n.config.classScale, Se(1), t);
          });
        }),
        (t.prototype.computeCoordLoss = function() {
          ...
          return zt(function() {
            return t.computeLossTerm(
              t.config.coordScale,
              Se(1),
              Rs(t.computeCoordBoxOffsetError(), t.computeCoordBoxSizeError())
            );
          });
        }),
        (t.prototype.computeCoordBoxOffsetError = function() {
          var r = this;
          return zt(function() {
            var t = r.toOutputTensorShape(r.coordBoxOffsetMask),
              e = Ws(t, r.toOutputTensorShape(r.computeCoordBoxOffsets())),
              n = Ws(t, oa(r.outputTensor));
            return qs(e, n);
          });
        }),
        (t.prototype.computeCoordBoxSizeError = function() {
          var r = this;
          return zt(function() {
            var t = r.toOutputTensorShape(r.coordBoxSizeMask),
              e = Ws(t, r.toOutputTensorShape(r.computeCoordBoxSizes())),
              n = Ws(t, r.outputTensor);
            return qs(e, n);
          });
        }),
        (t.prototype.computeLossTerm = function(t, e, n) {
          var r = this;
          return zt(function() {
            return Ws(Se(t), r.squaredSumOverMask(e, n));
          });
        }),
        (t.prototype.squaredSumOverMask = function(t, e) {
          return zt(function() {
            return ps(la(Ws(t, e)));
          });
        }),
        (t.prototype.validateGroundTruthBoxes = function(t) {
          var a = this;
          t.forEach(function(t) {
            var e = t.x,
              n = t.y,
            ...
            if (
              ...
              throw new Error(
                'invalid ground truth data, box is out of image boundaries ' +
                  JSON.stringify({ x: e, y: n, width: r, height: o })
              );
          });
        }),
          ...
          return t
            .map(function(t) {
              var e = t.x,
                ...
                o = t.height,
                i = t.label;
              return { box: new Ul(e, n, r, o), label: i };
            })
            .map(function(t) {
              var e = t.box,
                n = t.label,
                r = e.rescale(h.reshapedImgDims),
                o = r.left,
                i = r.top,
                a = (r.bottom, r.right, r.x, r.y, r.width),
                s = r.height,
                u = o + a / 2,
                c = i + s / 2,
                l = Math.floor((u / h.inputSize) * h.numCells);
              return {
                row: Math.floor((c / h.inputSize) * h.numCells),
                col: l,
                anchor: h.anchors
                  .map(function(t, e) {
                    return {
        ...
        (t.prototype.createGroundTruthMask = function() {
          var i = this,
            ...
            a = t.buffer();
          return (
            this.groundTruth.forEach(function(t) {
              for (
                var e = t.row, n = t.col, r = t.anchor, o = 0;
                o < i.boxEncodingSize;
                o++
              )
                a.set(1, e, n, r, o);
          ...
          return zt(function() {
            for (
              var t = Ae([
                ...
                e = Ae([c.numCells, c.numCells, c.numBoxes, c.boxEncodingSize]),
                n = Ae([c.numCells, c.numCells, c.numBoxes, c.boxEncodingSize]),
                r = t.buffer(),
                o = e.buffer(),
                i = n.buffer(),
                a = 0;
              ...
              for (var s = 0; s < c.numCells; s++)
                for (var u = 0; u < c.numBoxes; u++)
                  r.set(1, a, s, u, 0),
                    r.set(1, a, s, u, 1),
                    o.set(1, a, s, u, 2),
                    o.set(1, a, s, u, 3),
        ...
        (t.prototype.computeIous = function() {
          var c = this,
            t = Ae([this.numCells, this.numCells, this.gridCellEncodingSize]),
            l = t.buffer();
          return (
            this.groundTruth.forEach(function(t) {
              var e,
                ...
                o = t.anchor,
                i = t.box,
                a = c.predictedBoxes.find(
                  ((e = { row: n, col: r, anchor: o }),
                  function(t) {
                    return (
                      e.row === t.row &&
                      e.col === t.col &&
              ...
              var s = wh(
                  i.rescale(c.reshapedImgDims),
                  a.box.rescale(c.reshapedImgDims)
                ),
                u = c.boxEncodingSize * o;
              l.set(s, n, r, u + 4);
            }),
            t
          );
          ...
          return (
            this.groundTruth.forEach(function(t) {
              var e = t.row,
                n = t.col,
                r = t.anchor,
                o = t.box.rescale(c.reshapedImgDims),
                i = o.left,
                a = o.top,
                s = ((i + o.right) / 2 - 32 * n) / 32,
                u = ((a + o.bottom) / 2 - 32 * e) / 32;
          ...
          return (
            this.groundTruth.forEach(function(t) {
              var e = t.row,
                ...
                i = o.width,
                a = o.height,
                s = Math.log(i / (32 * c.anchors[r].x)),
                u = Math.log(a / (32 * c.anchors[r].y));
  ...
  !(function(r) {
    function t(t, e) {
      var n = r.call(this, t) || this;
      return (n._trainableConfig = Vh(t)), (n._optimizer = e), n;
    }
    ml(t, r),
      Object.defineProperty(t.prototype, 'trainableConfig', {
        get: function() {
      ...
      (t.prototype.backward = function(o, i, p, a) {
        return (
          void 0 === a && (a = {}),
          gl(this, void 0, void 0, function() {
            var n,
            ...
            return yl(this, function(t) {
              switch (t.label) {
                case 0:
                  return (
                    (e = a),
                    (n = Object.assign({}, { minBoxSize: 32 }, e)),
                    (r = n.minBoxSize),
                    (s = n.reportLosses),
                    (u = Tl(oh(o), p)),
                    (c = this.filterGroundTruthBoxes(i, u, r)).length
                      ? [4, xh(dh(o, p))]
                      : [2, null]
                  );
                case 1:
                  return (
                    ...
                    [
                      ...
                      this.optimizer.minimize(function() {
                        var t = h.computeLoss(h.forwardInput(l, p), c, u),
                          e = t.noObjectLoss,
                          n = t.objectLoss,
                          r = t.coordLoss,
                          o = t.classLoss,
                        ...
                        if (s) {
                          var a = {
                            losses: {
                              totalLoss: i.dataSync()[0],
                              noObjectLoss: e.dataSync()[0],
                              objectLoss: n.dataSync()[0],
                              coordLoss: r.dataSync()[0],
                              classLoss: o.dataSync()[0],
                            },
                            numBoxes: c.length,
                            inputSize: p,
                          };
      ...
      (t.prototype.computeLoss = function(t, e, n) {
        var r = Vh(this.config),
          o = Math.max(n.width, n.height);
        if (!o) throw new Error('computeLoss - invalid inputSize: ' + o);
        var i = this.extractBoxes(t, n);
        return zt(function() {
          return new Zh(t, e, i, n, r).computeLoss();
        });
      }),
      (t.prototype.filterGroundTruthBoxes = function(t, e, a) {
        ...
        return t.filter(function(t) {
          var e = t.x,
            ...
            r = t.width,
            o = t.height,
            i = new Ul(e, n, r, o).rescale({ height: s, width: u });
      ...
      (t.prototype.load = function(e) {
        return gl(this, void 0, void 0, function() {
          return yl(this, function(t) {
            switch (t.label) {
              case 0:
                return [4, r.prototype.load.call(this, e)];
              case 1:
                return t.sent(), this.variable(), [2];
            }
          });
        });
      });
  ...
  function ep(t, e) {
    var o = Gl(t, e);
    function n(t) {
      return { filters: o(t + '/filters', 4), bias: o(t + '/bias', 1) };
    }
    function r(t) {
      var e = o(t + '/depthwise_filter', 4),
        n = o(t + '/pointwise_filter', 4),
  ...
  var np = (function(t) {
    ...
    return (
      ...
      (e.prototype.forwardInput = function(e) {
        ...
        return zt(function() {
          var t = Ph(
            Eh(e.toBatchTensor(112, !0), [122.782, 117.001, 104.298]).div(
              Se(255)
            ),
            n.dense0,
            !0
          ...
          return (
            (t = Ph((t = Ph((t = Ph(t, n.dense1)), n.dense2)), n.dense3)),
      ...
      (e.prototype.extractParamsFromWeigthMap = function(t) {
        return (
          (r = ep((e = t), (n = [])).extractDenseBlock4Params),
          (o = {
            dense0: r('dense0', !0),
            dense1: r('dense1'),
            dense2: r('dense2'),
      ...
      (e.prototype.extractParams = function(t) {
        return (function(t) {
          var e = [],
            ...
            i = tp(r, e).extractDenseBlock4Params,
            a = i(3, 32, 'dense0', !0),
            s = i(32, 64, 'dense1'),
            u = i(64, 128, 'dense2'),
            c = i(128, 256, 'dense3');
  ...
  var op = (function(r) {
      ...
      return (
        ...
        (t.prototype.runNet = function(e) {
          ...
          return zt(function() {
            var t =
              e instanceof yh ? n.faceFeatureExtractor.forwardInput(e) : e;
            return rp(t.as2D(t.shape[0], -1), r.fc);
          });
        }),
        ...
        (t.prototype.extractParamsFromWeigthMap = function(t) {
          var e,
            ...
            l = c.featureExtractorMap,
            h = c.classifierMap;
          return (
            this.faceFeatureExtractor.loadFromWeightMap(l),
            (s = Gl((o = h), (a = []))),
            (u = {
              fc: ((i = 'fc'),
              { weights: s(i + '/weights', 2), bias: s(i + '/bias', 1) }),
            }),
            Vl(o, a),
            { params: u, paramMappings: a }
          );
        }),
        (t.prototype.extractParams = function(t) {
    ...
    ap = (function(e) {
      ...
      return (
        ...
        (s.getFaceExpressionLabel = function(t) {
          ...
          if ('number' != typeof e)
            throw new Error(
              'getFaceExpressionLabel - no label for faceExpression: ' + t
            );
          return e;
        }),
        (s.decodeProbabilites = function(e) {
          ...
          return Object.keys(ip).map(function(t) {
            return { expression: t, probability: e[ip[t]] };
          });
        }),
                ...
                case 2:
                  return (
                    ...
                    [
                      ...
                      Promise.all(
                        Ii(n).map(function(n) {
                          return gl(i, void 0, void 0, function() {
                            var e;
                            return yl(this, function(t) {
                              switch (t.label) {
                                case 0:
                ...
                case 1:
                  return (
                    ...
                    [
                      ...
                      Promise.all(
                        e.map(function(a, s) {
                          return gl(r, void 0, void 0, function() {
                            var e, n, r, o, i;
                            return yl(this, function(t) {
                              switch (t.label) {
                                case 0:
  ...
  var cp = (function(t) {
      ...
      return (
        ...
        (e.prototype.extractParamsFromWeigthMap = function(t) {
          return (
            (r = ep((e = t), (n = [])).extractDenseBlock3Params),
            (o = {
              dense0: r('dense0', !0),
              dense1: r('dense1'),
              dense2: r('dense2'),
        ...
        (e.prototype.extractParams = function(t) {
          return (function(t) {
            var e = [],
              ...
              r = n.extractWeights,
              o = n.getRemainingWeights,
              i = tp(r, e).extractDenseBlock3Params,
              a = i(3, 32, 'dense0', !0),
              s = i(32, 64, 'dense1'),
              u = i(64, 128, 'dense2');
            if (0 !== o().length)
  ...
  function gp(t, e) {
    var n,
      r,
      o = ((n = t), (r = e.conv1), pp(n, r, [1, 1], !0));
    return (o = fp(o, e.conv2)), (o = Rs(o, t)), (o = nu(o));
  }
  function yp(t, e) {
    var n = dp(t, e.conv1);
    n = fp(n, e.conv2);
    ...
    return (r = i ? Vo([r, o], 3) : r), (n = Rs(r, n)), (n = nu(n));
  }
  var xp = (function(t) {
    function e() {
    ...
    return (
      ...
      (e.prototype.forwardInput = function(n) {
        ...
        return zt(function() {
          var t = dp(
              Eh(n.toBatchTensor(150, !0).toFloat(), [
                122.782,
                117.001,
                104.298,
              ]).div(Se(256)),
      ...
      (e.prototype.extractParamsFromWeigthMap = function(t) {
        return (function(t) {
          var e = [],
            ...
            w = t.fc;
          if ((e.push({ originalPath: 'fc', paramPath: 'fc' }), !El(w)))
            throw new Error(
          ...
          return Vl(t, e), { params: b, paramMappings: e };
        })(t);
      }),
      (e.prototype.extractParams = function(t) {
        return (function(t) {
  ...
  function Cp(t, e) {
    var n = t.detection.box,
      ...
      a = {
        ...
        alignedRect: new _h(t.detection.score, o.rescale(i.reverse()), i),
      };
  ...
  function Rp(t) {
    ...
    return Vl(t, e), { params: a, paramMappings: e };
  }
  function Np(e, n, r) {
    return zt(function() {
      var t = Fa(e, n.filters, r, 'same');
      return (t = Rs(t, n.batch_norm_offset)), Hi(t, 0, 6);
    });
  }
  var kp = 0.0010000000474974513;
  function Tp(t, e) {
    return zt(function() {
      var u = null,
        c = Np(t, e.conv_0, [2, 2]);
  ...
  function Ip(t, e) {
    var n,
      ...
      o = ((n = Ii(ou(t, [1, 0]))),
      {
        ...
        centers: [Rs(n[0], Ds(r[0], Se(2))), Rs(n[1], Ds(r[1], Se(2)))],
      }),
      i = o.sizes,
      a = o.centers,
      s = Ii(ou(e, [1, 0])),
      u = Ds(Ws(Ki(Ds(s[2], Se(5))), i[0]), Se(2)),
      c = Rs(Ws(Ds(s[0], Se(10)), i[0]), a[0]),
      l = Ds(Ws(Ki(Ds(s[3], Se(5))), i[1]), Se(2)),
      h = Rs(Ws(Ds(s[1], Se(10)), i[1]), a[1]);
  ...
  function Ap(e, n) {
    return zt(function() {
      var t = e.shape[0];
      return {
        boxPredictionEncoding: _i(Bh(e, n.box_encoding_predictor), [
          t,
          -1,
          1,
          4,
        ]),
        classPrediction: _i(Bh(e, n.class_predictor), [t, -1, 3]),
      };
    });
  }
  var Mp = (function() {
    ...
    Op = (function(t) {
      ...
      return (
        ...
        (e.prototype.forwardInput = function(u) {
          ...
          return zt(function() {
            var l,
              ...
              e = Tp(qs(Ws(t, Se(0.007843137718737125)), Se(1)), c.mobilenetv1),
              n = ((l = e.out),
              (h = e.conv11),
              (p = c.prediction_layer),
              zt(function() {
                var t = Np(Np(l, p.conv_0, [1, 1]), p.conv_1, [2, 2]),
                  e = Np(Np(t, p.conv_2, [1, 1]), p.conv_3, [2, 2]),
                  n = Np(Np(e, p.conv_4, [1, 1]), p.conv_5, [2, 2]),
                  r = Np(Np(n, p.conv_6, [1, 1]), p.conv_7, [2, 2]),
                  o = Ap(h, p.box_predictor_0),
                  i = Ap(l, p.box_predictor_1),
                  a = Ap(t, p.box_predictor_2),
                  s = Ap(e, p.box_predictor_3),
                  u = Ap(n, p.box_predictor_4),
                  c = Ap(r, p.box_predictor_5);
                return {
                  boxPredictions: Vo(
                    [
            ...
            return (
              ...
              zt(function() {
                ...
                var n = oa(Qa(i, [0, 0, 1], [-1, -1, -1])),
                  r = Qa(n, [0, 0, 0], [-1, -1, 1]);
                return (
                  (r = _i(r, [t, r.shape[1]])), { boxes: Ii(e), scores: Ii(r) }
                );
              })
            );
          });
        ...
        (e.prototype.locateFaces = function(T, D) {
          return (
            void 0 === D && (D = {}),
            gl(this, void 0, void 0, function() {
                ...
                switch (t.label) {
                  ...
                  case 2:
                    return (
                      ...
                      (k = C.map(function(t) {
                        var e = [
                            Math.max(0, g.get(t, 0)),
                            Math.min(1, g.get(t, 2)),
                          ].map(function(t) {
                            return t * N;
                          }),
                          n = e[0],
                          r = e[1],
                          o = [
                            Math.max(0, g.get(t, 1)),
                            Math.min(1, g.get(t, 3)),
                          ].map(function(t) {
                            return t * R;
                          }),
                          i = o[0],
                          a = o[1];
                        return new _h(w[t], new Ul(i, n, a - i, r - n), {
        ...
        (e.prototype.extractParams = function(t) {
          return (function(t) {
            var e = [],
              ...
              u = a(),
              c = s(),
              l = { extra_dim: Ne(r(20472), [1, 5118, 4]) };
            if (
      ...
      i = (function(r, o) {
        ...
        return {
          extractPNetParams: function() {
            ...
            return vl({}, t, { conv4_1: e, conv4_2: n });
          },
          extractRNetParams: function() {
            ...
            return vl({}, t, { fc1: e, prelu4_alpha: n, fc2_1: r, fc2_2: o });
          },
  ...
  function Vp(t) {
    var e = [],
      ...
      u = i();
    return (
      Vl(t, e), { params: { pnet: a, rnet: s, onet: u }, paramMappings: e }
    );
  }
  function Gp(t, e) {
    var n = e[0],
  ...
  function qp(t) {
    return zt(function() {
      return Ws(qs(t, Se(127.5)), Se(0.0078125));
    });
  }
  function jp(t, e) {
    return zt(function() {
  ...
  function $p(e, n, r) {
    return (
      void 0 === r && (r = !1),
      zt(function() {
        var t = Bh(e, n.conv1, 'valid');
        return (
          (t = jp(t, n.prelu1_alpha)),
          (t = jp(
            (t = Bh(
              (t = Ka(t, r ? [2, 2] : [3, 3], [2, 2], 'same')),
              n.conv2,
              'valid'
            )),
            n.prelu2_alpha
        ...
        .map(function(l) {
          return zt(function() {
            var o,
              ...
              (i = l),
              zt(function() {
                var t = Gp(i, o.shape.slice(1)),
                  e = t.height,
                  n = t.width,
                  r = qp(ju.resizeBilinear(o, [e, n]));
                return ou(r, [0, 2, 1, 3]);
              })),
              n = Date.now(),
              s = ((r = e),
              ...
              zt(function() {
                var t = $p(r, a, !0),
                  e = Bh(t, a.conv4_1, 'valid'),
                  n = pi(us(e, 3), 3);
                return {
                  prob: ye(qs(e, n), 3),
                  regions: Bh(t, a.conv4_2, 'valid'),
                };
              })),
              u = s.prob,
              c = s.regions;
            ...
            i = (function(e, n, r, t) {
              for (var o = [], i = 0; i < e.shape[0]; i++)
                for (var a = 0; a < e.shape[1]; a++)
                  e.get(i, a) >= t && o.push(new wl(a, i));
              return o.map(function(t) {
                return {
                  cell: new Pl(
                    Math.round((t.y * Wp + 1) / r),
                    Math.round((t.x * Wp + 1) / r),
                    Math.round((t.y * Wp + zp) / r),
                    Math.round((t.x * Wp + zp) / r)
                  ),
                  score: e.get(t.y, t.x),
                  region: new Hp(
                    n.get(t.y, t.x, 0),
          ...
          case 0:
            return (
              ...
              [
                ...
                Promise.all(
                  r.map(function(c) {
                    return gl(n, void 0, void 0, function() {
                      var e, n, r, o, i, a, s, u;
                      return yl(this, function(t) {
                        return (
                          ...
                          [2, Zl.isNodejs() ? ah(u) : createImageBitmap(u)]
                        );
                      });
                    });
                  })
          ...
          case 1:
            return (
              ...
              [
                ...
                i.map(function(t) {
                  return zt(function() {
                    return qp(ou(ke(t, [1, a, s, 3]), [0, 2, 1, 3]).toFloat());
                  });
                }),
              ]
            );
  ...
  function Yp(m, v, g, y, x) {
    return gl(this, void 0, void 0, function() {
      var e, n, r, o, i, a, s, u, c, l, h, p, f, d;
      return yl(this, function(t) {
        switch (t.label) {
          case 0:
            return (e = Date.now()), [4, Xp(m, v, { width: 24, height: 24 })];
          case 1:
            return (
              (n = t.sent()),
              ...
              (r = n.map(function(t) {
                var a,
                  ...
                  zt(function() {
                    var t = $p(a, s),
                      e = jp(
                        rp(_i(t, [t.shape[0], s.fc1.weights.shape[0]]), s.fc1),
                        s.prelu4_alpha
                      ),
                      n = rp(e, s.fc2_1),
                      r = pi(us(n, 1), 1),
                      o = ye(qs(n, r), 1),
                      i = rp(e, s.fc2_2);
                    return { scores: Ii(o, 1)[1], regions: i };
                  }));
                return t.dispose(), e;
              })),
          ...
          case 2:
            return (
              ...
              0 < c.length &&
                ...
                (d = f.map(function(t) {
                  return new Hp(
                    r[u[t]].regions.get(0, 0),
                    r[u[t]].regions.get(0, 1),
                    r[u[t]].regions.get(0, 2),
                    r[u[t]].regions.get(0, 3)
                  );
                })),
                (p = f.map(function(t) {
                  return l[t];
  ...
  function Qp(v, g, y, x, w) {
    return gl(this, void 0, void 0, function() {
      var e, n, o, r, i, a, s, u, c, l, h, p, f, d, m;
      return yl(this, function(t) {
        switch (t.label) {
          case 0:
            return (e = Date.now()), [4, Xp(v, g, { width: 48, height: 48 })];
          case 1:
            return (
              (n = t.sent()),
              ...
              (o = n.map(function(t) {
                var s,
                  ...
                  zt(function() {
                    ...
                    var e = jp(
                        rp(_i(t, [t.shape[0], u.fc1.weights.shape[0]]), u.fc1),
                        u.prelu5_alpha
                      ),
                      n = rp(e, u.fc2_1),
                      r = pi(us(n, 1), 1),
                      ...
                      i = rp(e, u.fc2_2),
                      a = rp(e, u.fc2_3);
                    return { scores: Ii(o, 1)[1], regions: i, points: a };
                  }));
                return t.dispose(), e;
              })),
              ...
              0 < l.length &&
                ...
                (d = m.map(function(n, r) {
                  return Array(5)
                    ...
                    .map(function(t, e) {
                      return new wl(
                        o[n].points.get(0, e) * (p[r].width + 1) + p[r].left,
                        o[n].points.get(0, e + 5) * (p[r].height + 1) + p[r].top
                      );
                    });
                }))),
              o.forEach(function(t) {
  ...
  var Jp = (function(t) {
                  ...
                  case 0:
                    ...
                    return (
                      ...
                      (v = (
                        ...
                        .filter(function(t) {
                          var e = Gp(t, [u, c]);
                          return Math.min(e.width, e.height) > zp;
                        })
                        .slice(0, f)),
                      (r.scales = v),
                        ...
                        return Cp(
                          ...
                          new Nh(
                            w.points[t].map(function(t) {
                              return t
                                .sub(new wl(e.left, e.top))
                                .div(new wl(e.width, e.height));
                            }),
    ...
    Zp = [
      new wl(1.603231, 2.094468),
      new wl(6.041143, 7.080126),
      new wl(2.882459, 3.518061),
      new wl(4.266906, 5.178857),
      new wl(9.041765, 10.66308),
    ],
    tf = [117.001, 114.697, 97.404],
    ef = (function(e) {
      function t() {
        var t = {
                ...
                case 1:
                  return [
                    ...
                    t.sent().map(function(t) {
                      return new _h(t.score, t.relativeBox, {
                        width: t.imageWidth,
    ...
    nf = [
      new wl(0.738768, 0.874946),
      new wl(2.42204, 2.65704),
      new wl(4.30971, 7.04493),
      new wl(10.246, 4.59428),
      new wl(12.6868, 11.8741),
    ],
    rf = [
      new wl(1.603231, 2.094468),
      new wl(6.041143, 7.080126),
    ...
    af = (function(n) {
      function t(t) {
        ...
        var e = Object.assign(
          ...
          t
            ? { anchors: rf, meanRgb: of }
            : { anchors: nf, withClassScores: !0 }
        );
    ...
    sf = {
      ...
      tinyFaceDetector: new ef(),
      tinyYolov2: new af(),
      mtcnn: new Jp(),
      faceLandmark68Net: new up(),
      faceLandmark68TinyNet: new lp(),
      faceRecognitionNet: new xp(),
      faceExpressionNet: new ap(),
    },
    uf = function(t, e) {
      return sf.ssdMobilenetv1.locateFaces(t, e);
    },
    cf = function(t) {
      return sf.faceLandmark68Net.detectLandmarks(t);
    },
    lf = function(t) {
      return sf.ssdMobilenetv1.load(t);
    },
    hf = lf,
    pf = uf,
    ff = cf,
              ...
              switch (t.label) {
                ...
                case 1:
                  return (
                    ...
                    this.input instanceof it ? [4, Mh(this.input, n)] : [3, 3]
                  );
                case 2:
                  return (r = t.sent()), [3, 5];
                case 3:
                  return [4, Ah(this.input, n)];
                case 4:
                  (r = t.sent()), (t.label = 5);
                case 5:
                  return (
                    ...
                    [
                      ...
                      Promise.all(
                        e.map(function(n, r) {
                          return gl(a, void 0, void 0, function() {
                            var e;
                            return yl(this, function(t) {
                              switch (t.label) {
                                case 0:
                                  return [
                                    4,
                                    sf.faceRecognitionNet.computeFaceDescriptor(
                                      o[r]
                                    ),
                                  ];
                                case 1:
                                  return (e = t.sent()), [2, wp(n, e)];
                              }
                            });
                          });
                        })
            ...
            return yl(this, function(t) {
              switch (t.label) {
                ...
                case 5:
                  return (
                    (r = o),
                    [4, sf.faceRecognitionNet.computeFaceDescriptor(r[0])]
                  );
                case 6:
                  return (
                    (i = t.sent()),
        ...
        Object.defineProperty(t.prototype, 'landmarkNet', {
          get: function() {
            return this.useTinyLandmarkNet
              ? sf.faceLandmark68TinyNet
              : sf.faceLandmark68Net;
          },
          enumerable: !0,
          configurable: !0,
        }),
    ...
    bf = (function(t) {
      ...
      return (
                ...
                case 5:
                  return (
                    ...
                    [
                      ...
                      Promise.all(
                        r.map(function(t) {
                          return sf.faceExpressionNet.predictExpressions(t);
                        })
                      ),
                    ]
                  );
        ...
        (e.prototype.withFaceLandmarks = function() {
          return new yf(this, this.input, !1);
        }),
        e
      );
    })(wf),
          ...
          return gl(this, void 0, void 0, function() {
            ...
            return yl(this, function(t) {
              switch (t.label) {
                ...
                case 5:
                  return (
                    (r = o), [4, sf.faceExpressionNet.predictExpressions(r[0])]
                  );
                case 6:
                  return (
                    (i = t.sent()),
      ...
      return (
            ...
            return yl(this, function(t) {
              switch (t.label) {
                case 0:
                  return (
                    (n = (e = this).input),
                    (r = e.options) instanceof Sp
                      ? [4, sf.mtcnn.forward(n, r)]
                      : [3, 2]
                  );
                case 1:
                  return [
                ...
                case 2:
                  if (
                    !(o =
                      r instanceof Bp
                        ? function(t) {
                            return sf.tinyFaceDetector.locateFaces(t, r);
                          }
                        : r instanceof Mp
                        ? function(t) {
                            return sf.ssdMobilenetv1.locateFaces(t, r);
                          }
                        : r instanceof Qh
                        ? function(t) {
                            return sf.tinyYolov2.locateFaces(t, r);
                          }
                        : null)
                  )
                    throw new Error(
        ...
        (e.prototype.runAndExtendWithFaceDetections = function() {
          ...
          return new Promise(function(n) {
            return gl(t, void 0, void 0, function() {
              var e;
              return yl(this, function(t) {
                switch (t.label) {
                  case 0:
        ...
        (e.prototype.withFaceLandmarks = function(t) {
          return (
            void 0 === t && (t = !1),
            new yf(this.runAndExtendWithFaceDetections(), this.input, t)
          );
        }),
        (e.prototype.withFaceExpressions = function() {
          return new bf(this.runAndExtendWithFaceDetections(), this.input);
        }),
        e
      );
    })(Cf),
    _f = (function(t) {
      ...
      return (
        ...
        (e.prototype.run = function() {
          return gl(this, void 0, void 0, function() {
            ...
            return yl(this, function(t) {
              switch (t.label) {
                case 0:
                  return [4, new Sf(this.input, this.options)];
                case 1:
                  return (
                    (e = t.sent()),
                    (n = e[0]),
              ...
              return yl(this, function(t) {
                switch (t.label) {
                  case 0:
                    return [4, this.run()];
                  case 1:
                    return (e = t.sent()), [2, n(e ? bp({}, e) : void 0)];
                }
              });
            });
          });
        ...
        (e.prototype.withFaceLandmarks = function(t) {
          return (
            void 0 === t && (t = !1),
            new xf(this.runAndExtendWithFaceDetection(), this.input, t)
          );
        }),
        (e.prototype.withFaceExpressions = function() {
          return new Ef(this.runAndExtendWithFaceDetection(), this.input);
        }),
        e
      );
    })(Cf);
  function Rf(t, e) {
    return void 0 === e && (e = new Mp()), new Sf(t, e);
  }
  function Nf(e, n) {
    return gl(this, void 0, void 0, function() {
      return yl(this, function(t) {
  ...
  var Df = (function() {
    function t(t, e) {
      ...
      this._labeledDescriptors = n.map(function(t) {
        ...
        if (t instanceof Float32Array) return new Dh(o(), [t]);
        if (t.descriptor && t.descriptor instanceof Float32Array)
          return new Dh(o(), [t.descriptor]);
        throw new Error(
      ...
      (t.prototype.matchDescriptor = function(r) {
        ...
        return this.labeledDescriptors
          .map(function(t) {
            var e = t.descriptors,
              n = t.label;
            return new Th(n, o.computeMeanDistance(r, e));
          })
          .reduce(function(t, e) {
  ...
  (t.tf = fl),
    ...
    (t.Dimensions = xl),
    (t.LabeledBox = Ll),
    (t.ObjectDetection = Wl),
    (t.Point = wl),
    (t.PredictedBox = zl),
    (t.Rect = Ul),
    (t.disposeUnusedWeightTensors = Vl),
    (t.extractWeightEntryFactory = Gl),
    (t.extractWeightsFactory = Hl),
    (t.getModelUris = ql),
    (t.awaitMediaLoaded = eh),
    (t.bufferToImage = nh),
    (t.createCanvas = ih),
    (t.createCanvasFromMedia = ah),
    (t.drawBox = uh),
    (t.drawDetection = function(t, e, l) {
      var n = Zl.getEnv().Canvas,
        h = lh(t);
      if (!(h instanceof n))
        throw new Error(
    ...
    (t.fetchNetWeights = function(n) {
      return gl(this, void 0, void 0, function() {
        ...
        return yl(this, function(t) {
          switch (t.label) {
            case 0:
              return (e = Float32Array.bind), [4, hh(n)];
            case 1:
    ...
    (t.fetchOrThrow = hh),
    (t.getContext2dOrThrow = rh),
    (t.getDefaultDrawOptions = sh),
    (t.getMediaDimensions = oh),
    (t.imageTensorToCanvas = fh),
    (t.imageToSquare = dh),
    (t.isMediaElement = mh),
    (t.isMediaLoaded = th),
    (t.loadWeightMap = vh),
    ...
    (t.round = Nl),
    (t.isDimensions = kl),
    (t.computeReshapedDimensions = Tl),
    (t.getCenterPoint = Dl),
    (t.range = Il),
    (t.isValidNumber = Al),
    (t.isValidProbablitiy = Ml),
    (t.NeuralNetwork = Sh),
    (t.FaceDetection = _h),
    (t.FaceLandmarks = Rh),
    (t.FaceLandmarks5 = Nh),
    (t.FaceLandmarks68 = kh),
    (t.FaceMatch = Th),
    (t.LabeledFaceDescriptors = Dh),
    (t.drawContour = Ih),
    (t.drawLandmarks = function(t, e, n) {
      var r = lh(t);
      if (!(r instanceof Zl.getEnv().Canvas))
        throw new Error(
          'drawLandmarks - expected canvas to be of type: HTMLCanvasElement'
        );
      var o = Object.assign(sh(n), n || {}),
        i = Object.assign({ drawLines: !1 }, n || {}).drawLines,
        a = rh(r),
        s = o.lineWidth,
        u = o.color,
        c = void 0 === u ? 'blue' : u;
      (Array.isArray(e) ? e : [e]).forEach(function(t) {
        if (i && t instanceof kh)
          return (
            (a.strokeStyle = c),
            (a.lineWidth = s),
            Ih(a, t.getJawOutline()),
            Ih(a, t.getLeftEyeBrow()),
            Ih(a, t.getRightEyeBrow()),
            Ih(a, t.getNose()),
            Ih(a, t.getLeftEye(), !0),
            Ih(a, t.getRightEye(), !0),
            void Ih(a, t.getMouth(), !0)
          );
        var e = s / 2;
        (a.fillStyle = c),
    ...
    (t.drawFaceExpressions = function(t, e, n) {
      var u = lh(t);
      if (!(u instanceof Zl.getEnv().Canvas))
        throw new Error(
          'drawFaceExpressions - expected canvas to be of type: HTMLCanvasElement'
        );
      var r = Object.assign(sh(n), n || {}),
        c = rh(u),
        o = r.primaryColor,
        l = void 0 === o ? 'red' : o,
        i = r.secondaryColor,
      ...
      (Array.isArray(e) ? e : [e]).forEach(function(t) {
        ...
        a.forEach(function(t, e) {
          var n = t.expression + ' (' + Nl(t.probability) + ')';
          ch(c, r, o + i + e * p + s, n, {
            textColor: 0 === e ? l : h,
            fontSize: 0 === e ? p : f,
          });
    ...
    (t.extractFaces = Ah),
    (t.extractFaceTensors = Mh),
    (t.FaceExpressionNet = ap),
    (t.faceExpressionLabels = ip),
    (t.FaceLandmarkNet = hp),
    (t.FaceLandmark68Net = up),
    (t.FaceLandmark68TinyNet = lp),
    (t.createFaceRecognitionNet = function(t) {
      var e = new xp();
      return e.extractWeights(t), e;
    }),
    (t.FaceRecognitionNet = xp),
    (t.extendWithFaceDescriptor = wp),
    (t.extendWithFaceDetection = bp),
    (t.extendWithFaceExpressions = Ep),
    (t.extendWithFaceLandmarks = Cp),
    (t.allFacesSsdMobilenetv1 = Nf),
    ...
    (t.allFaces = kf),
    (t.ComposableTask = Lp),
    (t.ComputeFaceDescriptorsTaskBase = df),
    (t.ComputeAllFaceDescriptorsTask = mf),
    (t.ComputeSingleFaceDescriptorTask = vf),
    (t.detectSingleFace = function(t, e) {
      return void 0 === e && (e = new Mp()), new _f(t, e);
    }),
    (t.detectAllFaces = Rf),
    (t.DetectFacesTaskBase = Cf),
    (t.DetectAllFacesTask = Sf),
    (t.DetectSingleFaceTask = _f),
    (t.DetectFaceLandmarksTaskBase = gf),
    (t.DetectAllFaceLandmarksTask = yf),
    (t.DetectSingleFaceLandmarksTask = xf),
    (t.FaceMatcher = Df),
    (t.nets = sf),
    (t.ssdMobilenetv1 = uf),
    (t.tinyFaceDetector = function(t, e) {
      return sf.tinyFaceDetector.locateFaces(t, e);
    }),
    (t.tinyYolov2 = function(t, e) {
      return sf.tinyYolov2.locateFaces(t, e);
    }),
    (t.mtcnn = function(t, e) {
      return sf.mtcnn.forward(t, e);
    }),
    (t.detectFaceLandmarks = cf),
    (t.detectFaceLandmarksTiny = function(t) {
      return sf.faceLandmark68TinyNet.detectLandmarks(t);
    }),
    (t.computeFaceDescriptor = function(t) {
      return sf.faceRecognitionNet.computeFaceDescriptor(t);
    }),
    (t.recognizeFaceExpressions = function(t) {
      return sf.faceExpressionNet.predictExpressions(t);
    }),
    (t.loadSsdMobilenetv1Model = lf),
    (t.loadTinyFaceDetectorModel = function(t) {
      return sf.tinyFaceDetector.load(t);
    }),
    (t.loadMtcnnModel = function(t) {
      return sf.mtcnn.load(t);
    }),
    (t.loadTinyYolov2Model = function(t) {
      return sf.tinyYolov2.load(t);
    }),
    (t.loadFaceLandmarkModel = function(t) {
      return sf.faceLandmark68Net.load(t);
    }),
    (t.loadFaceLandmarkTinyModel = function(t) {
      return sf.faceLandmark68TinyNet.load(t);
    }),
    (t.loadFaceRecognitionModel = function(t) {
      return sf.faceRecognitionNet.load(t);
    }),
    (t.loadFaceExpressionModel = function(t) {
      return sf.faceExpressionNet.load(t);
    }),
    (t.loadFaceDetectionModel = hf),
    (t.locateFaces = pf),
    (t.detectLandmarks = ff),
    ...
    (t.Mtcnn = Jp),
    (t.MtcnnOptions = Sp),
    (t.createSsdMobilenetv1 = Fp),
    (t.createFaceDetectionNet = function(t) {
      return Fp(t);
    }),
    (t.FaceDetectionNet = Pp),
    (t.SsdMobilenetv1 = Op),
    (t.SsdMobilenetv1Options = Mp),
    (t.createTinyFaceDetector = function(t) {
      var e = new ef();
      return e.extractWeights(t), e;
    }),
    (t.TinyFaceDetector = ef),
    (t.TinyFaceDetectorOptions = Bp),
    ...
    (t.resizeResults = function e(t, n) {
      ...
      if (Array.isArray(t))
        return t.map(function(t) {
          return e(t, { width: r, height: o });
        });
      var i = t.unshiftedLandmarks && t.unshiftedLandmarks instanceof Rh,
        a = t.detection && t.detection instanceof _h;
      if (i) {
      ...
      return a
        ? bp(t, t.detection.forSize(r, o))
        : t instanceof Rh || t instanceof _h
        ? t.forSize(r, o)
        : t;
    }),
